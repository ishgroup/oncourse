records.each { Contact c ->
	csv << [
			...
			"email"                          : c.email,
			"fax"                            : c.fax,
			"permission"                     : c.customFields.find { cf -> cf.customFieldType.name == "Permission " }?.value,
			"customerCode"                   : c.customFields.find { cf -> cf.customFieldType.name == "Customer Code" }?.value,
			"payrollNumber"                  : c.customFields.find { cf -> cf.customFieldType.name == "Payroll number" }?.value,
			"authorisationFile"              : c.customFields.find { cf -> cf.customFieldType.name == "Authorisation File #" }?.value,
