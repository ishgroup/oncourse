...
class MoneyUtilTest {
    ...
    static {
        ...
        listTwo.put(Money.of("5"), Money.of("-0.01"))
        ...
        listTwo.put(Money.of("60"), Money.of("-0.01"))
        ...
        listTwo.put(Money.of("71"), Money.of("-0.01"))
        ...
        listTwo.put(Money.of("170"), Money.of("-0.01"))
        ...
        listTwo.put(Money.of("95.97"), Money.of("-0.01"))
