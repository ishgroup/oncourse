...
class ReportBuilderTest {
    ...
    void buildTest() throws Exception {
        ...
        Assertions.assertEquals("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "              name=\"TransactionDetailReport\" language=\"groovy\" pageWidth=\"595\" pageHeight=\"842\" columnWidth=\"539\"\n" +
                "              leftMargin=\"28\" rightMargin=\"28\" topMargin=\"28\" bottomMargin=\"28\" whenResourceMissingType=\"Empty\"\n" +
                "              uuid=\"bb9b77bc-db0e-4603-9203-7dcd1c50a4fd\">\n" +
                ...
                "  <style name=\"default\" isDefault=\"true\" forecolor=\"#000000\" vTextAlign=\"Bottom\" markup=\"none\" fontName=\"Open Sans\"\n" +
                "         fontSize=\"9\" isBold=\"false\" isItalic=\"false\" isUnderline=\"false\" isStrikeThrough=\"false\" pdfFontName=\"OpenSans\"\n" +
                "         pdfEncoding=\"Cp1252\" isPdfEmbedded=\"true\">\n" +
                "    <paragraph spacingAfter=\"9\"/>\n" +
                "  </style>\n" +
                "  <style name=\"header 1\" style=\"default\" forecolor=\"#4F0018\" vTextAlign=\"Middle\" fontName=\"Open Sans Light\"\n" +
                "         fontSize=\"18\" pdfFontName=\"Open Sans Light\"/>\n" +
                "</jasperReport>\n", report.getReport())
    }
}