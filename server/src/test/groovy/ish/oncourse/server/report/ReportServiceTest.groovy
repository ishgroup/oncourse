...
class ReportServiceTest extends TestWithDatabase {
    ...
    void testCustomFontReport() throws InterruptedException, IOException {
        ...
        PrintWorker worker = new PrintWorker(request, cayenneService, injector.getInstance(DocumentService.class), injector.getInstance(UserPreferenceService.class), MoneyManager.systemContext) {
