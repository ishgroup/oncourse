...
class DelayedEnrolmentIncomePostingJobTest extends CayenneIshTestCase {
	...
	void testGetPercentageOfDeliveredScheduledHours() {
		...
		assertEquals(new BigDecimal("0.00"), cc1.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start1, -1)))
		assertEquals(new BigDecimal("0.00"), cc2.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start1, -1)))
		assertEquals(new BigDecimal("0.00"), cc3.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start1, -1)))
		assertEquals(new BigDecimal("0.00"), cc4.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start1, -1)))

		assertEquals(new BigDecimal("0.33"), cc1.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start1, 1)))
		assertEquals(new BigDecimal("0.00"), cc2.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start1, 1)))
		assertEquals(new BigDecimal("0.50"), cc3.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start1, 1)))
		assertEquals(new BigDecimal("0.00"), cc4.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start1, 1)))

		assertEquals(new BigDecimal("0.33"), cc1.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start2, -1)))
		assertEquals(new BigDecimal("0.00"), cc2.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start2, -1)))
		assertEquals(new BigDecimal("0.50"), cc3.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start2, -1)))
		assertEquals(new BigDecimal("0.00"), cc4.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start2, -1)))

		assertEquals(new BigDecimal("0.67"), cc1.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start2, 1)))
		assertEquals(new BigDecimal("0.33"), cc2.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start2, 1)))
		assertEquals(new BigDecimal("1.00"), cc3.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start2, 1)))
		assertEquals(new BigDecimal("0.00"), cc4.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start2, 1)))

		assertEquals(new BigDecimal("0.67"), cc1.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start3, -1)))
		assertEquals(new BigDecimal("0.33"), cc2.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start3, -1)))
		assertEquals(new BigDecimal("1.00"), cc3.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start3, -1)))
		assertEquals(new BigDecimal("0.00"), cc4.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start3, -1)))

		assertEquals(new BigDecimal("1.00"), cc1.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start3, 1)))
		assertEquals(new BigDecimal("0.67"), cc2.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start3, 1)))
		assertEquals(new BigDecimal("1.00"), cc3.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start3, 1)))
		assertEquals(new BigDecimal("0.50"), cc4.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start3, 1)))

		assertEquals(new BigDecimal("1.00"), cc1.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start4, -1)))
		assertEquals(new BigDecimal("0.67"), cc2.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start4, -1)))
		assertEquals(new BigDecimal("1.00"), cc3.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start4, -1)))
		assertEquals(new BigDecimal("0.50"), cc4.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start4, -1)))

		assertEquals(new BigDecimal("1.00"), cc1.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start4, 1)))
		assertEquals(new BigDecimal("1.00"), cc2.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start4, 1)))
		assertEquals(new BigDecimal("1.00"), cc3.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start4, 1)))
		assertEquals(new BigDecimal("1.00"), cc4.getPercentageOfDeliveredScheduledHoursBeforeDate(DateUtils.addHours(start4, 1)))

		assertEquals(new BigDecimal("0.67"), cc1.getPercentageOfDeliveredScheduledHoursBeforeDate(new Date()))
		assertEquals(new BigDecimal("0.33"), cc2.getPercentageOfDeliveredScheduledHoursBeforeDate(new Date()))
		assertEquals(new BigDecimal("1.00"), cc3.getPercentageOfDeliveredScheduledHoursBeforeDate(new Date()))
		assertEquals(new BigDecimal("0.00"), cc4.getPercentageOfDeliveredScheduledHoursBeforeDate(new Date()))
	}
	...
	void testProcessInvoiceLine1() {
		...
		assertEquals(new Money("33.00"), at.getAmount())
		...
		assertEquals(new Money("67.0"), invoiceLine.getPrepaidFeesRemaining())
	}
	...
	void testProcessInvoiceLine2() {
		...
		AccountTransaction at = getLastAccountTransactionForInvoiceLineWithId(newContext, 800L, getRecordWithId(newContext, Account.class, 200L))
		assertEquals(new Money("100.00"), at.getAmount())
		at = getLastAccountTransactionForInvoiceLineWithId(newContext, 800L, getRecordWithId(newContext, Account.class, 500L))
		assertEquals(new Money("-100.00"), at.getAmount())

		assertEquals(Money.ZERO, invoiceLine.getPrepaidFeesRemaining())
	...
	void testPostAtFirstSessionNoSessionsStarted() {
		...
		assertEquals(new Money("33.0"), invoiceLine.getPrepaidFeesRemaining())
		...
		assertEquals(new Money("100.0"), invoiceLine.getPrepaidFeesRemaining())
		...
		assertEquals(new Money("10.0"), invoiceLine.getPrepaidFeesRemaining())
		...
		assertEquals(new Money("80.0"), invoiceLine.getPrepaidFeesRemaining())
	...
	void testPostAtFirstSessionSomeSessionsStarted() {
		...
		at = getAccountTransactionsForInvoiceLineWithId(newContext, 200L, getRecordWithId(newContext, Account.class, 200L))
		assertEquals(new Money("33.00"), at.get(0).getAmount())
		at = getAccountTransactionsForInvoiceLineWithId(newContext, 200L, getRecordWithId(newContext, Account.class, 500L))
		assertEquals(new Money("-33.00"), at.get(0).getAmount())
		invoiceLine = SelectById.query(InvoiceLine.class, 200).selectOne(newContext)
		assertEquals(Money.ZERO, invoiceLine.getPrepaidFeesRemaining())
		...
		at = getAccountTransactionsForInvoiceLineWithId(newContext, 400L, getRecordWithId(newContext, Account.class, 200L))
		assertEquals(new Money("100.00"), at.get(0).getAmount())
		at = getAccountTransactionsForInvoiceLineWithId(newContext, 400L, getRecordWithId(newContext, Account.class, 500L))
		assertEquals(new Money("-100.00"), at.get(0).getAmount())
		invoiceLine = SelectById.query(InvoiceLine.class, 400).selectOne(newContext)
		assertEquals(Money.ZERO, invoiceLine.getPrepaidFeesRemaining())
		...
		at = getAccountTransactionsForInvoiceLineWithId(newContext, 500L, getRecordWithId(newContext, Account.class, 200L))
		assertEquals(new Money("67.00"), at.get(0).getAmount())
		at = getAccountTransactionsForInvoiceLineWithId(newContext, 500L, getRecordWithId(newContext, Account.class, 500L))
		assertEquals(new Money("-67.00"), at.get(0).getAmount())
		invoiceLine = SelectById.query(InvoiceLine.class, 500).selectOne(newContext)
		assertEquals(Money.ZERO, invoiceLine.getPrepaidFeesRemaining())
		...
		at = getAccountTransactionsForInvoiceLineWithId(newContext, 600L, getRecordWithId(newContext, Account.class, 200L))
		assertEquals(new Money("10.00"), at.get(0).getAmount())
		at = getAccountTransactionsForInvoiceLineWithId(newContext, 600L, getRecordWithId(newContext, Account.class, 500L))
		assertEquals(new Money("-10.00"), at.get(0).getAmount())
		invoiceLine = SelectById.query(InvoiceLine.class, 600).selectOne(newContext)
		assertEquals(Money.ZERO, invoiceLine.getPrepaidFeesRemaining())
		...
		at = getAccountTransactionsForInvoiceLineWithId(newContext, 900L, getRecordWithId(newContext, Account.class, 200L))
		assertEquals(new Money("80.00"), at.get(0).getAmount())
		at = getAccountTransactionsForInvoiceLineWithId(newContext, 900L, getRecordWithId(newContext, Account.class, 500L))
		assertEquals(new Money("-80.00"), at.get(0).getAmount())
		invoiceLine = SelectById.query(InvoiceLine.class, 900).selectOne(newContext)
		assertEquals(Money.ZERO, invoiceLine.getPrepaidFeesRemaining())
	...
	void testPostAtFirstSessionAllSessionsStarted() {
		...
		assertEquals(new Money("67.00"), at.getAmount())
		...
		assertEquals(new Money("10.00"), at.getAmount())
		...
		assertEquals(new Money("80.00"), at.getAmount())
	...
	void testPostAtEverySessionNoSessionsStarted() {
		...
		assertEquals(new Money("80.00"), getRecordWithId(newContext, InvoiceLine.class, 900L).getFinalPriceToPayExTax())
	...
	void testPostAtEverySessionSomeSessionsStarted() {
		...
		at = getAccountTransactionsForInvoiceLineWithId(newContext, 900L, getRecordWithId(newContext, Account.class, 200L))
		assertEquals(new Money("26.40"), at.get(0).getAmount())
		at = getAccountTransactionsForInvoiceLineWithId(newContext, 900L, getRecordWithId(newContext, Account.class, 500L))
		assertEquals(new Money("-26.40"), at.get(0).getAmount())
		invoiceLine = SelectById.query(InvoiceLine.class, 900).selectOne(newContext)
		assertEquals(new Money("53.60"), invoiceLine.getPrepaidFeesRemaining())
	...
	void testPostAtEverySessionAllSessionsStarted() {
		...
		at = getLastAccountTransactionForInvoiceLineWithId(newContext, 500L, getRecordWithId(newContext, Account.class, 200L))
		assertEquals(new Money("34.00"), at.getAmount())
		at = getLastAccountTransactionForInvoiceLineWithId(newContext, 500L, getRecordWithId(newContext, Account.class, 500L))
		assertEquals(new Money("-34.00"), at.getAmount())
		invoiceLine = SelectById.query(InvoiceLine.class, 500).selectOne(newContext)
		assertEquals(new Money("33.0"), invoiceLine.getPrepaidFeesRemaining())
		...
		at = getLastAccountTransactionForInvoiceLineWithId(newContext, 700L, getRecordWithId(newContext, Account.class, 200L))
		assertEquals(new Money("-40.00"), at.getAmount())
		at = getLastAccountTransactionForInvoiceLineWithId(newContext, 700L, getRecordWithId(newContext, Account.class, 500L))
		assertEquals(new Money("40.00"), at.getAmount())
		invoiceLine = SelectById.query(InvoiceLine.class, 700).selectOne(newContext)
		assertEquals(new Money("50.0"), invoiceLine.getPrepaidFeesRemaining())
		...
		at = getLastAccountTransactionForInvoiceLineWithId(newContext, 900L, getRecordWithId(newContext, Account.class, 200L))
		assertEquals(new Money("53.60"), at.getAmount())
		at = getLastAccountTransactionForInvoiceLineWithId(newContext, 900L, getRecordWithId(newContext, Account.class, 500L))
		assertEquals(new Money("-53.60"), at.getAmount())
		invoiceLine = SelectById.query(InvoiceLine.class, 900).selectOne(newContext)
		assertEquals(new Money("26.40"), invoiceLine.getPrepaidFeesRemaining())
	...
	void testSelfPacedEnrolment() {
		...
		assertEquals(new Money("50.00"), at.getAmount())
	...
	void testCreateNewInvoiceLine() {
		...
		assertEquals(new Money("8.00"), at.getAmount())
		...
		if (!(list.get(0).getAmount().equals(new Money("80.00")) && list.get(1).getAmount().equals(new Money("8.00")))) {
			if (!(list.get(1).getAmount().equals(new Money("80.00")) && list.get(0).getAmount().equals(new Money("8.00")))) {
		...
		assertEquals("after prepaid fees job tansactions towards liability account transactions are incorrect", new Money("26.40"),list.get(0).getAmount())


		list = getAccountTransactionsForInvoiceLineWithId(newContext, il.getId(), getRecordWithId(newContext, Account.class, 500L))
		if (!(list.get(0).getAmount().equals(new Money("80.00")) && list.get(1).getAmount().equals(new Money("-26.40")))) {
			if (!(list.get(0).getAmount().equals(new Money("-26.40")) && list.get(1).getAmount().equals(new Money("80.00")))) {
	...
	private AccountTransaction getLastAccountTransactionForInvoiceLineWithId(DataContext context, Long invoiceLineId, Account account) {
	...
	private List<AccountTransaction> getAccountTransactionsForInvoiceLineWithId(DataContext context, Long invoiceLineId, Account account) {
		Expression expression = ExpressionFactory.matchExp(_AccountTransaction.TABLE_NAME_PROPERTY, AccountTransactionType.INVOICE_LINE)
		expression = expression.andExp(ExpressionFactory.matchExp(_AccountTransaction.FOREIGN_RECORD_ID_PROPERTY, invoiceLineId))
		expression = expression.andExp(ExpressionFactory.matchExp(AccountTransaction.ACCOUNT_PROPERTY, account))
		List<AccountTransaction> list = context.select(SelectQuery.query(AccountTransaction.class, expression, Arrays.asList(AccountTransaction.CREATED_ON.desc())))
