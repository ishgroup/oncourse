...
class ConcurrentReportPrintingTest extends TestWithDatabase {
    ...
    void testReport() throws Exception {
        ...
        for (int counter : reportsToTest) {
            ...
            PrintWorker worker = new PrintWorker(request, cayenneService, injector.getInstance(PreferenceController.class) as DocumentService, injector.getInstance(UserPreferenceService.class),  Money.ZERO.currencyContext)
