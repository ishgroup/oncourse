...
final class TagUtil {
     ...
     * @return Expression
     */
    static Expression createExpressionForTagsWithinOneTagTree(String alias, List<Tag> tags, TaggableClasses entity) {
     ...
     * @return Expression
     */
    static Expression createExpressionForTag(String alias, Tag tag, TaggableClasses entity) {
