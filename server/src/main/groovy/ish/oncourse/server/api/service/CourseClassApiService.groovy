...
class CourseClassApiService extends TaggableApiService<CourseClassDTO, CourseClass, CourseClassDao> {
    ...
    CourseClassDTO toRestModel(CourseClass cc) {
        ...
        dto.documents = cc.activeAttachments.collect { toRestDocument(it.document, documentService) }
        ...
        dto.specialTypeTags = cc.hiddenTags.collect { it.id }
        return dto
    }
    ...
    CourseClass toCayenneModel(CourseClassDTO dto, CourseClass courseClass) {
        ...
        updateTags(courseClass, courseClass.taggingRelations, dto.tags + dto.specialTypeTags, CourseClassTagRelation, courseClass.context)
