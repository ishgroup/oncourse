...
import ish.oncourse.server.cayenne.glue._TagAttachmentRelation

import javax.annotation.Nonnull

/**
 * A persistent class mapped as "TagAttachmentRelation" Cayenne entity.
 */
class TagAttachmentRelation extends _TagAttachmentRelation {
	...
	void setAttachedRelation(AttachableTrait attachable) {
		super.setAttachedTag((Tag) attachable)
	}
