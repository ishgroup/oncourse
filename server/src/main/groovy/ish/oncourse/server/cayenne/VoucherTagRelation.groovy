...
import ish.oncourse.server.cayenne.glue._VoucherTagRelation

import javax.annotation.Nonnull

class VoucherTagRelation extends _VoucherTagRelation{
    /**
    ...
    TaggableClasses getTaggableClassesIdentifier() {
        return TaggableClasses.VOUCHER
    }
    ...
    void setTaggedRelation(Taggable object) {
        super.setTaggedVoucher((Voucher) object)
    }
}
