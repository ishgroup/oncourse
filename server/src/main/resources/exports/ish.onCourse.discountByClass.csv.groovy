...
records.each { CourseClass cc ->
  ...
  def totalFee = totalInvoiceLinesFee.add(fullFeeSum.add(cc.manuallyDiscountedEnrolmentsFeesSum ?: BigDecimal.ZERO))
  def totalDiscount = totalInvoiceLinesDiscount.add(cc.manuallyDiscountedEnrolmentsDiscountSum ?: BigDecimal.ZERO)
	...
	csv << [
        ...
        "Discount value"           : new ish.math.Money("0.0"),
