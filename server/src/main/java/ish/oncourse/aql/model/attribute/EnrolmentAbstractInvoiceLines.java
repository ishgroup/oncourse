...
public class EnrolmentAbstractInvoiceLines implements SyntheticAttributeDescriptor {
    private EntityFactory factory;

    public EnrolmentAbstractInvoiceLines(EntityFactory factory) {
    ...
    public SimpleNode spawnNode() {
        return new SyntheticCompoundNodeTemplate(getAttributeName(),
                Enrolment.INVOICE_LINES.outer().getExpression(),
                Enrolment.QUOTE_LINES.outer().getExpression());
    }
}
