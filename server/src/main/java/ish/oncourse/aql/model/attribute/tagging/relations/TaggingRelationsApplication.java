...
public class TaggingRelationsApplication extends AbstractTaggingRelations {

    public TaggingRelationsApplication(EntityFactory factory) {
        super(factory);
    }
    ...
    public Optional<Entity> nextEntity() {
        return Optional.of(factory.createEntity(ApplicationTagRelation.class));
    }
}
