...
public class TaggingRelationsDocument extends AbstractTaggingRelations {

    public TaggingRelationsDocument(EntityFactory factory) {
        super(factory);
    }
    ...
    public Optional<Entity> nextEntity() {
        return Optional.of(factory.createEntity(DocumentTagRelation.class));
    }
}
