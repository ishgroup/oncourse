...
public class TaggingRelationsCourseClass extends AbstractTaggingRelations {

    public TaggingRelationsCourseClass(EntityFactory factory) {
        super(factory);
    }
    ...
    public Optional<Entity> nextEntity() {
        return Optional.of(factory.createEntity(CourseClassTagRelation.class));
    }
}
