...
public class TaggingRelationsAssessment extends AbstractTaggingRelations {

    public TaggingRelationsAssessment(EntityFactory factory) {
        super(factory);
    }
    ...
    public Optional<Entity> nextEntity() {
        return Optional.of(factory.createEntity(AssessmentTagRelation.class));
    }
}
