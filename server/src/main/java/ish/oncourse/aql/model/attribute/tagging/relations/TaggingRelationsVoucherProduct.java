...
public class TaggingRelationsVoucherProduct extends AbstractTaggingRelations {

    public TaggingRelationsVoucherProduct(EntityFactory factory) {
        super(factory);
    }

    @Override
    public Class<? extends Persistent> getEntityType() {
        return VoucherProduct.class;
    }

    @Override
    public Optional<Entity> nextEntity() {
        return Optional.of(factory.createEntity(VoucherProductTagRelation.class));
    }
}
