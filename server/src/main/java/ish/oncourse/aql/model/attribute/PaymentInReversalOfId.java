...
public class PaymentInReversalOfId implements SyntheticAttributeDescriptor {

    private EntityFactory factory;

    public PaymentInReversalOfId(EntityFactory factory) {
    ...
    public SimpleNode spawnNode() {
        return new LazyExpressionNode() {
            ...
            public SimpleNode resolveParent(SimpleNode parent, List<SimpleNode> args, CompilationContext ctx) {
                ...
                ExpressionUtil.addChild(parent, PaymentIn.REVERSAL_OF.getExpression(), 0);
