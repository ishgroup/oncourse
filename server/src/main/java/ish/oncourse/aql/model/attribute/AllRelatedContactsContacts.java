...
public class AllRelatedContactsContacts implements SyntheticAttributeDescriptor {

    private final EntityFactory factory;

    public AllRelatedContactsContacts(EntityFactory factory) {
    ...
    public SimpleNode spawnNode() {
        return new SyntheticCompoundNodeTemplate(getAttributeName(),
                Contact.TO_CONTACTS.outer()
                .dot(ContactRelation.TO_CONTACT).outer()
                .getExpression(),
                Contact.FROM_CONTACTS.outer()
