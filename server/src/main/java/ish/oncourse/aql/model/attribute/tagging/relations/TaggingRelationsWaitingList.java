...
public class TaggingRelationsWaitingList extends AbstractTaggingRelations {

    public TaggingRelationsWaitingList(EntityFactory factory) {
        super(factory);
    }
    ...
    public Optional<Entity> nextEntity() {
        return Optional.of(factory.createEntity(WaitingListTagRelation.class));
    }
}
