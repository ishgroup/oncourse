...
public class TaggingRelationsContact extends AbstractTaggingRelations {

    public TaggingRelationsContact(EntityFactory factory) {
        super(factory);
    }
    ...
    public Optional<Entity> nextEntity() {
        return Optional.of(factory.createEntity(ContactTagRelation.class));
    }
}
