...
public class TaggingRelationsRoom extends AbstractTaggingRelations {

    public TaggingRelationsRoom(EntityFactory factory) {
        super(factory);
    }
    ...
    public Optional<Entity> nextEntity() {
        return Optional.of(factory.createEntity(RoomTagRelation.class));
    }
}
