...
public class TaggingRelationsEnrolment extends AbstractTaggingRelations {

    public TaggingRelationsEnrolment(EntityFactory factory) {
        super(factory);
    }
    ...
    public Optional<Entity> nextEntity() {
        return Optional.of(factory.createEntity(EnrolmentTagRelation.class));
    }
}
