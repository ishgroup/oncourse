...
public class LazyAccountComparisonNode extends LazyEntityComparisonNode {

    LazyAccountComparisonNode(Op op) {
        super(op);
    }
    ...
    protected SimpleNode createNode() {
        ...
        return createComparisionNode(pathString + "accountCode", value.getSearchString());
    }
