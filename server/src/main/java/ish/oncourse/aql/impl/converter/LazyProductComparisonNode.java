...
public class LazyProductComparisonNode extends LazyEntityComparisonNode {

    LazyProductComparisonNode(Op op) {
        super(op);
    }
    ...
    protected SimpleNode createNode() {
        ...
        var productNameNode = createComparisionNode(pathString + Product.NAME.getName(), value.getProductName());
        var productSkuNode = createComparisionNode(pathString + Product.SKU.getName(), value.getProductName());
