...
public class LazyTransactionComparisonNode extends LazyEntityComparisonNode {

    LazyTransactionComparisonNode(Op op) {
        super(op);
    }
    ...
    protected SimpleNode createNode() {
        ...
        return createComparisionNode(pathString + "account.accountCode", value.getSearchString());
    }
