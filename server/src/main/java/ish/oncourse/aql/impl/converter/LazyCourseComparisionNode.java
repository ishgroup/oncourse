...
public class LazyCourseComparisionNode extends LazyEntityComparisonNode {

    LazyCourseComparisionNode(Op op) {
        super(op);
    }
    ...
    protected SimpleNode createNode() {
        ...
        var name = createComparisionNode(pathString + Course.NAME.getName(), value.getSearchString());
        var code = createComparisionNode(pathString + Course.CODE.getName(), value.getSearchString());
