...
1. add this libraries to solr/server/lib/ish:
jts-1.13.jar
mysql-connector-java-5.1.38.jar
spatial4j-0.5.jar
2. add this libraries to solr/server/lib
...
./bin/solr start -m 1g -c -z localhost:2181,localhost:2182,localhost:2183 -p <port> -s <solr.home>
port - tcp port for this solr server: 7001,7002 .....
