...
public class IUSIServiceGetNonDvsDocumentTypesErrorInfoFaultFaultMessageSingle extends Exception {
    ...
    public IUSIServiceGetNonDvsDocumentTypesErrorInfoFaultFaultMessageSingle(String message, au.gov.usi._2020.ws.ErrorInfo errorInfo) {
        super(message);
        this.errorInfo = errorInfo;
    }

    public IUSIServiceGetNonDvsDocumentTypesErrorInfoFaultFaultMessageSingle(String message, au.gov.usi._2020.ws.ErrorInfo errorInfo, Throwable cause) {
        super(message, cause);
        this.errorInfo = errorInfo;
    }
