 ...
 * 2021-02-24T17:30:47.716+11:00
 * Generated source version: 3.3.6
 *
 */
public final class IUSIService_WS2007FederationHttpBindingIUSIService_Client {

    private static final QName SERVICE_NAME = new QName("http://usi.gov.au/2020/ws/servicepolicy", "USIService");
    ...
    public static void main(String args[]) throws Exception {
        ...
        au.gov.usi._2020.ws.GetCountriesType _getCountries_in = null;
        try {
            au.gov.usi._2020.ws.GetCountriesResponseType _getCountries__return = port.getCountries(_getCountries_in);
        ...
        au.gov.usi._2020.ws.BulkVerifyUSIType _bulkVerifyUSI_in = null;
        try {
            au.gov.usi._2020.ws.BulkVerifyUSIResponseType _bulkVerifyUSI__return = port.bulkVerifyUSI(_bulkVerifyUSI_in);
        ...
        au.gov.usi._2020.ws.CreateUSIType _createUSI_in = null;
        try {
            au.gov.usi._2020.ws.CreateUSIResponseType _createUSI__return = port.createUSI(_createUSI_in);
        ...
        au.gov.usi._2020.ws.UpdateUSIContactDetailsType _updateUSIContactDetails_in = null;
        try {
            au.gov.usi._2020.ws.UpdateUSIContactDetailsResponseType _updateUSIContactDetails__return = port.updateUSIContactDetails(_updateUSIContactDetails_in);
        ...
        au.gov.usi._2020.ws.BulkUploadRetrieveType _bulkUploadRetrieve_in = null;
        try {
            au.gov.usi._2020.ws.BulkUploadRetrieveResponseType _bulkUploadRetrieve__return = port.bulkUploadRetrieve(_bulkUploadRetrieve_in);
        ...
        au.gov.usi._2020.ws.UpdateUSIPersonalDetailsType _updateUSIPersonalDetails_in = null;
        try {
            au.gov.usi._2020.ws.UpdateUSIPersonalDetailsResponseType _updateUSIPersonalDetails__return = port.updateUSIPersonalDetails(_updateUSIPersonalDetails_in);
        ...
        au.gov.usi._2020.ws.VerifyUSIType _verifyUSI_in = null;
        try {
            au.gov.usi._2020.ws.VerifyUSIResponseType _verifyUSI__return = port.verifyUSI(_verifyUSI_in);
        ...
        au.gov.usi._2020.ws.GetNonDvsDocumentTypesType _getNonDvsDocumentTypes_in = null;
        try {
            au.gov.usi._2020.ws.GetNonDvsDocumentTypesResponseType _getNonDvsDocumentTypes__return = port.getNonDvsDocumentTypes(_getNonDvsDocumentTypes_in);
        ...
        au.gov.usi._2020.ws.LocateUSIType _locateUSI_in = null;
        try {
            au.gov.usi._2020.ws.LocateUSIResponseType _locateUSI__return = port.locateUSI(_locateUSI_in);
        ...
        au.gov.usi._2020.ws.BulkUploadType _bulkUpload_in = null;
        try {
            au.gov.usi._2020.ws.BulkUploadResponseType _bulkUpload__return = port.bulkUpload(_bulkUpload_in);
