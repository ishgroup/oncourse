...
public class IUSIServiceGetCountriesErrorInfoFaultFaultMessageSingle extends Exception {
    ...
    public IUSIServiceGetCountriesErrorInfoFaultFaultMessageSingle(String message, au.gov.usi._2018.ws.ErrorInfo errorInfo, java.lang.Throwable cause) {
        super(message, cause);
        this.errorInfo = errorInfo;
    }
