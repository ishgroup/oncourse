...
public class IUSIServiceLocateUSIErrorInfoFaultFaultMessageSingle extends Exception {
    ...
    public IUSIServiceLocateUSIErrorInfoFaultFaultMessageSingle(String message, java.lang.Throwable cause) {
        super(message, cause);
    }
    ...
    public IUSIServiceLocateUSIErrorInfoFaultFaultMessageSingle(String message, au.gov.usi._2018.ws.ErrorInfo errorInfo, java.lang.Throwable cause) {
        super(message, cause);
        this.errorInfo = errorInfo;
    }
