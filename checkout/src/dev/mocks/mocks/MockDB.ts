...
export class MockDB {
  ...
  createEnrolment(contactId: string, classId: string, errors = false, warnings = false): Enrolment {
    return {
  ...
  createApplication(contactId: string, classId: string, errors = false, warnings = false): Application {
    return {
      contactId: this.contacts.entities.contact[contactId].id,
      classId: this.classes.entities.classes[classId].id,
      errors: errors ? [faker.hacker.phrase(), faker.hacker.phrase()] : [],
  ...
  createVoucher(contactId: string, productId: string, errors = false, warnings = false): Voucher {
    return {
      contactId: this.contacts.entities.contact[contactId].id,
      ...
      total: this.products.entities.products[productId].price,
      quantity: 1
    };
  }

  createMembership(contactId: string, productId: string, errors = false, warnings = false): Membership {
    return {
      contactId: this.contacts.entities.contact[contactId].id,
      productId: this.products.entities.products[productId].id,
      errors: errors ? [faker.hacker.phrase(), faker.hacker.phrase()] : [],
  ...
  createArticle(contactId: string, productId: string, errors = false, warnings = false): Article {
    return {
      contactId: this.contacts.entities.contact[contactId].id,
      productId: this.products.entities.products[productId].id,
      errors: errors ? [faker.hacker.phrase(), faker.hacker.phrase()] : [],
  ...
  createWaitingList(contactId: string, courseId: string, errors = false, warnings = false): WaitingList {
    return {
      studentsCount: 1,
      detail: '',
      fieldHeadings: [],
