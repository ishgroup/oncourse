...
class SolrCourseClassQueryWithBeforeAfterFilterTest extends ASolrTest {
    ...
    @Test
    void testSortCoursesWithDeforeAfterFilter() {
        ...
        List<SCourse> actualSCourses = solrClient.query("courses",
                SolrQueryBuilder.valueOf(new SearchParams(s: "course*", after: new Date(), before: new Date() + 7), cCollege.college.id.toString(), null, null).build())
