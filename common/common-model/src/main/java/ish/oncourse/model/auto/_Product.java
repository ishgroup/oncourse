...
public abstract class _Product extends CayenneDataObject {
    ...
    public void addToProductItems(Voucher obj) {
        addToManyTarget("productItems", obj, true);
    }
    public void removeFromProductItems(Voucher obj) {
        removeToManyTarget("productItems", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<Voucher> getProductItems() {
        return (List<Voucher>)readProperty("productItems");
    }
