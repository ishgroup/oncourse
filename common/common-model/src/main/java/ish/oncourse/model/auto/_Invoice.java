...
public abstract class _Invoice extends CayenneDataObject {
    ...
    public BigDecimal getAmountOwing() {
        return (BigDecimal)readProperty(AMOUNT_OWING_PROPERTY);
    }
    ...
    public BigDecimal getTotalExGst() {
        return (BigDecimal)readProperty(TOTAL_EX_GST_PROPERTY);
    }
    ...
    public BigDecimal getTotalGst() {
        return (BigDecimal)readProperty(TOTAL_GST_PROPERTY);
    }
