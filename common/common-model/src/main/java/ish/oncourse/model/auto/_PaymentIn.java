...
public abstract class _PaymentIn extends CayenneDataObject {
    ...
    public static final String REDEEMED_VOUCHER_PROPERTY = "redeemedVoucher";
    ...
    public void setRedeemedVoucher(Voucher redeemedVoucher) {
        setToOneTarget("redeemedVoucher", redeemedVoucher, true);
    }

    public Voucher getRedeemedVoucher() {
        return (Voucher)readProperty("redeemedVoucher");
    }
