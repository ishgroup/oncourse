 ...
 *         &lt;element name="codeRequired" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
    ...
    extends ReplicationStub
{
    ...
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean codeRequired;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the codeRequired property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the codeRequired property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
