 ...
 * 2021-10-19T20:57:17.539+11:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "ReplicationService",
                  wsdlLocation = "/wsdl/v24_replication.wsdl",
                  targetNamespace = "http://repl.v24.soap.webservices.oncourse.ish/")
public class ReplicationService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://repl.v24.soap.webservices.oncourse.ish/", "ReplicationService");
    public final static QName ReplicationPort = new QName("http://repl.v24.soap.webservices.oncourse.ish/", "ReplicationPort");
    public final static QName PaymentPortType = new QName("http://repl.v24.soap.webservices.oncourse.ish/", "PaymentPortType");
    static {
        URL url = ReplicationService.class.getResource("/wsdl/v24_replication.wsdl");
        if (url == null) {
            url = ReplicationService.class.getClassLoader().getResource("/wsdl/v24_replication.wsdl");
        }
        if (url == null) {
            java.util.logging.Logger.getLogger(ReplicationService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "/wsdl/v24_replication.wsdl");
        }
        WSDL_LOCATION = url;
    }
