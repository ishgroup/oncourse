...
package ish.oncourse.webservices.v5.stubs.reference;
 ...
 * generated in the ish.oncourse.webservices.v5.stubs.reference package. 
...
public class ObjectFactory {
    ...
    private final static QName _Country_QNAME = new QName("http://ref.v5.soap.webservices.oncourse.ish/", "country");
    private final static QName _Qualification_QNAME = new QName("http://ref.v5.soap.webservices.oncourse.ish/", "qualification");
    private final static QName _Module_QNAME = new QName("http://ref.v5.soap.webservices.oncourse.ish/", "module");
    private final static QName _Language_QNAME = new QName("http://ref.v5.soap.webservices.oncourse.ish/", "language");
    private final static QName _TrainingPackage_QNAME = new QName("http://ref.v5.soap.webservices.oncourse.ish/", "trainingPackage");
    private final static QName _ReferenceResult_QNAME = new QName("http://ref.v5.soap.webservices.oncourse.ish/", "referenceResult");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ish.oncourse.webservices.v5.stubs.reference
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ref.v5.soap.webservices.oncourse.ish/", name = "country")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ref.v5.soap.webservices.oncourse.ish/", name = "qualification")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ref.v5.soap.webservices.oncourse.ish/", name = "module")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ref.v5.soap.webservices.oncourse.ish/", name = "language")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ref.v5.soap.webservices.oncourse.ish/", name = "trainingPackage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ref.v5.soap.webservices.oncourse.ish/", name = "referenceResult")
