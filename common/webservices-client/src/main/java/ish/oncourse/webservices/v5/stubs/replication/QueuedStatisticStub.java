...
public class QueuedStatisticStub extends ReplicationStub implements GenericQueuedStatisticStub {
    ...
    /**
	 * @see ish.oncourse.webservices.v4.stubs.replication.ReplicationStub#getAngelId()
	 */
	@Override
	...
	/**
	 * @see ish.oncourse.webservices.v4.stubs.replication.ReplicationStub#getEntityIdentifier()
	 */
	@Override
