 ...
 * 2015-05-11T17:25:50.061+03:00
 * Generated source version: 2.6.16
 * 
 */
@WebServiceClient(name = "ReferenceService", 
                  wsdlLocation = "/wsdl/v5_reference.wsdl",
                  targetNamespace = "http://ref.v5.soap.webservices.oncourse.ish/") 
public class ReferenceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ref.v5.soap.webservices.oncourse.ish/", "ReferenceService");
    public final static QName ReferencePort = new QName("http://ref.v5.soap.webservices.oncourse.ish/", "ReferencePort");
    static {
        URL url = ReferenceService.class.getResource("/wsdl/v5_reference.wsdl");
        if (url == null) {
            url = ReferenceService.class.getClassLoader().getResource("/wsdl/v5_reference.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(ReferenceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "/wsdl/v5_reference.wsdl");
        }       
        WSDL_LOCATION = url;
    }
