 ...
 * 2019-01-30T22:54:20.843+11:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "ReplicationService",
                  wsdlLocation = "/wsdl/v19_replication.wsdl",
                  targetNamespace = "http://repl.v19.soap.webservices.oncourse.ish/")
public class ReplicationService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://repl.v19.soap.webservices.oncourse.ish/", "ReplicationService");
    public final static QName ReplicationPort = new QName("http://repl.v19.soap.webservices.oncourse.ish/", "ReplicationPort");
    public final static QName PaymentPortType = new QName("http://repl.v19.soap.webservices.oncourse.ish/", "PaymentPortType");
    static {
        URL url = ReplicationService.class.getResource("/wsdl/v19_replication.wsdl");
        if (url == null) {
            url = ReplicationService.class.getClassLoader().getResource("/wsdl/v19_replication.wsdl");
        }
        if (url == null) {
            java.util.logging.Logger.getLogger(ReplicationService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "/wsdl/v19_replication.wsdl");
        }
        WSDL_LOCATION = url;
    }
