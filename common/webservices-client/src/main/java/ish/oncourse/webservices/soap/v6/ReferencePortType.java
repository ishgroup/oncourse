 ...
 * 
 */
@WebService(targetNamespace = "http://ref.v6.soap.webservices.oncourse.ish/", name = "ReferencePortType")
@XmlSeeAlso({ish.oncourse.webservices.v6.stubs.reference.ObjectFactory.class})
...
public interface ReferencePortType {
    ...
    public ish.oncourse.webservices.v6.stubs.reference.ReferenceResult getRecords(
