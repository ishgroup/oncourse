...
@WebServiceClient(name = "ReferenceService", 
                  wsdlLocation = "/wsdl/v6_reference.wsdl",
                  targetNamespace = "http://ref.v6.soap.webservices.oncourse.ish/") 
public class ReferenceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ref.v6.soap.webservices.oncourse.ish/", "ReferenceService");
    public final static QName ReferencePort = new QName("http://ref.v6.soap.webservices.oncourse.ish/", "ReferencePort");
    static {
        URL url = ReferenceService.class.getResource("/wsdl/v6_reference.wsdl");
        if (url == null) {
            url = ReferenceService.class.getClassLoader().getResource("/wsdl/v6_reference.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(ReferenceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "/wsdl/v6_reference.wsdl");
        }       
        WSDL_LOCATION = url;
    }
