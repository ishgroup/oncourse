...
public class V6ReferenceService extends ReferenceService {
	 ...
	 */
	@Inject
	public V6ReferenceService(ICountryService countryService, ILanguageService languageService, IQualificationService qualificationService,
