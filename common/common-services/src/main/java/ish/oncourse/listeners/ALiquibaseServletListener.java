...
public abstract class ALiquibaseServletListener extends OverrideLog4JListener {

    private static final Logger logger = Logger.getLogger(ALiquibaseServletListener.class);
        ...
        for (int i = 0; i < changeLogFiles.length; i++) {
            ...
            try {
                ...
                try {
                    ...
                    executeLiquibase(liquibase, contexts);
    ...
    protected abstract void executeLiquibase(Liquibase liquibase, String contexts) throws LiquibaseException;
}
