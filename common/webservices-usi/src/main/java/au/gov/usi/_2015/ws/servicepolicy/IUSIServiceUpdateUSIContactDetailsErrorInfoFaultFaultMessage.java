...
public class IUSIServiceUpdateUSIContactDetailsErrorInfoFaultFaultMessage extends Exception {
    ...
    public IUSIServiceUpdateUSIContactDetailsErrorInfoFaultFaultMessage(String message, au.gov.usi._2015.ws.ArrayOfErrorInfo arrayOfErrorInfo) {
        super(message);
        this.arrayOfErrorInfo = arrayOfErrorInfo;
    }

    public IUSIServiceUpdateUSIContactDetailsErrorInfoFaultFaultMessage(String message, au.gov.usi._2015.ws.ArrayOfErrorInfo arrayOfErrorInfo, Throwable cause) {
        super(message, cause);
        this.arrayOfErrorInfo = arrayOfErrorInfo;
    }
