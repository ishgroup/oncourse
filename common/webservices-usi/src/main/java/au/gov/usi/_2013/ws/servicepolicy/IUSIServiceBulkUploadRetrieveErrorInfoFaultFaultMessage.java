...
public class IUSIServiceBulkUploadRetrieveErrorInfoFaultFaultMessage extends Exception {
    ...
    public IUSIServiceBulkUploadRetrieveErrorInfoFaultFaultMessage(String message, au.gov.usi._2013.ws.ErrorInfoType errorInfo) {
        super(message);
        this.errorInfo = errorInfo;
    }

    public IUSIServiceBulkUploadRetrieveErrorInfoFaultFaultMessage(String message, au.gov.usi._2013.ws.ErrorInfoType errorInfo, Throwable cause) {
        super(message, cause);
        this.errorInfo = errorInfo;
    }
