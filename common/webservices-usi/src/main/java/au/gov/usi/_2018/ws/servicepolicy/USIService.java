 ...
 * 2020-04-04T01:49:03.307+11:00
 * Generated source version: 2.6.16
 * 
 */
@WebServiceClient(name = "USIService", 
                  wsdlLocation = "https://portal.usi.gov.au/Service/BatchCreateService.wsdl",
...
public class USIService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("https://portal.usi.gov.au/Service/BatchCreateService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(USIService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "https://portal.usi.gov.au/Service/BatchCreateService.wsdl");
        }
        WSDL_LOCATION = url;
    }
