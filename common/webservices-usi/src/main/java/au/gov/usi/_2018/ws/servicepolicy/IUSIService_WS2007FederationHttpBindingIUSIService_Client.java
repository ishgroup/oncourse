...
public final class IUSIService_WS2007FederationHttpBindingIUSIService_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        au.gov.usi._2018.ws.GetCountriesType _getCountries_in = new au.gov.usi._2018.ws.GetCountriesType();
        try {
        ...
        au.gov.usi._2018.ws.BulkUploadRetrieveType _bulkUploadRetrieve_in = new au.gov.usi._2018.ws.BulkUploadRetrieveType();
        try {
        ...
        au.gov.usi._2018.ws.UpdateUSIPersonalDetailsType _updateUSIPersonalDetails_in = new au.gov.usi._2018.ws.UpdateUSIPersonalDetailsType();
        try {
        ...
        au.gov.usi._2018.ws.BulkVerifyUSIType _bulkVerifyUSI_in = new au.gov.usi._2018.ws.BulkVerifyUSIType();
        try {
        ...
        au.gov.usi._2018.ws.CreateUSIType _createUSI_in = new au.gov.usi._2018.ws.CreateUSIType();
        try {
        ...
        au.gov.usi._2018.ws.UpdateUSIContactDetailsType _updateUSIContactDetails_in = new au.gov.usi._2018.ws.UpdateUSIContactDetailsType();
        try {
        ...
        au.gov.usi._2018.ws.GetNonDvsDocumentTypesType _getNonDvsDocumentTypes_in = new au.gov.usi._2018.ws.GetNonDvsDocumentTypesType();
        try {
        ...
        au.gov.usi._2018.ws.LocateUSIType _locateUSI_in = new au.gov.usi._2018.ws.LocateUSIType();
        try {
        ...
        au.gov.usi._2018.ws.VerifyUSIType _verifyUSI_in = new au.gov.usi._2018.ws.VerifyUSIType();
        try {
        ...
        au.gov.usi._2018.ws.BulkUploadType _bulkUpload_in = new au.gov.usi._2018.ws.BulkUploadType();
        try {
