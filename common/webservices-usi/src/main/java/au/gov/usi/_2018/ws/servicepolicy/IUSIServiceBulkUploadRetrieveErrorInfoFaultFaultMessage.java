...
public class IUSIServiceBulkUploadRetrieveErrorInfoFaultFaultMessage extends Exception {
    ...
    public IUSIServiceBulkUploadRetrieveErrorInfoFaultFaultMessage(String message, au.gov.usi._2018.ws.ArrayOfErrorInfo arrayOfErrorInfo, Throwable cause) {
        super(message, cause);
        this.arrayOfErrorInfo = arrayOfErrorInfo;
    }
