 ...
 * 2016-11-08T21:50:02.022+11:00
 * Generated source version: 2.6.16
 * 
 */
public final class IUSIService_WS2007FederationHttpBindingIUSIService_Client {

    private static final QName SERVICE_NAME = new QName("http://usi.gov.au/2015/ws/servicepolicy", "USIService");
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        au.gov.usi._2015.ws.LocateUSIType _locateUSI_in = null;
        try {
            au.gov.usi._2015.ws.LocateUSIResponseType _locateUSI__return = port.locateUSI(_locateUSI_in);
        ...
        au.gov.usi._2015.ws.GetNonDvsDocumentTypesType _getNonDvsDocumentTypes_in = null;
        try {
            au.gov.usi._2015.ws.GetNonDvsDocumentTypesResponseType _getNonDvsDocumentTypes__return = port.getNonDvsDocumentTypes(_getNonDvsDocumentTypes_in);
        ...
        au.gov.usi._2015.ws.VerifyUSIType _verifyUSI_in = null;
        try {
            au.gov.usi._2015.ws.VerifyUSIResponseType _verifyUSI__return = port.verifyUSI(_verifyUSI_in);
        ...
        au.gov.usi._2015.ws.BulkUploadType _bulkUpload_in = null;
        try {
            au.gov.usi._2015.ws.BulkUploadResponseType _bulkUpload__return = port.bulkUpload(_bulkUpload_in);
        ...
        au.gov.usi._2015.ws.BulkUploadRetrieveType _bulkUploadRetrieve_in = null;
        try {
            au.gov.usi._2015.ws.BulkUploadRetrieveResponseType _bulkUploadRetrieve__return = port.bulkUploadRetrieve(_bulkUploadRetrieve_in);
        ...
        au.gov.usi._2015.ws.UpdateUSIPersonalDetailsType _updateUSIPersonalDetails_in = null;
        try {
            au.gov.usi._2015.ws.UpdateUSIPersonalDetailsResponseType _updateUSIPersonalDetails__return = port.updateUSIPersonalDetails(_updateUSIPersonalDetails_in);
        ...
        au.gov.usi._2015.ws.CreateUSIType _createUSI_in = null;
        try {
            au.gov.usi._2015.ws.CreateUSIResponseType _createUSI__return = port.createUSI(_createUSI_in);
        ...
        au.gov.usi._2015.ws.UpdateUSIContactDetailsType _updateUSIContactDetails_in = null;
        try {
            au.gov.usi._2015.ws.UpdateUSIContactDetailsResponseType _updateUSIContactDetails__return = port.updateUSIContactDetails(_updateUSIContactDetails_in);
        ...
        au.gov.usi._2015.ws.BulkVerifyUSIType _bulkVerifyUSI_in = null;
        try {
            au.gov.usi._2015.ws.BulkVerifyUSIResponseType _bulkVerifyUSI__return = port.bulkVerifyUSI(_bulkVerifyUSI_in);
