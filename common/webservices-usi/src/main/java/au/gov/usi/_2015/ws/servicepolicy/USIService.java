 ...
 * 2016-11-08T21:50:02.157+11:00
 * Generated source version: 2.6.16
 * 
 */
@WebServiceClient(name = "USIService", 
                  wsdlLocation = "/wsdl/USIServiceV2.wsdl",
                  targetNamespace = "http://usi.gov.au/2015/ws/servicepolicy") 
public class USIService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://usi.gov.au/2015/ws/servicepolicy", "USIService");
    public final static QName WS2007FederationHttpBindingIUSIService = new QName("http://usi.gov.au/2015/ws/servicepolicy", "WS2007FederationHttpBinding_IUSIService");
    static {
        URL url = USIService.class.getResource("/wsdl/USIServiceV2.wsdl");
        if (url == null) {
            url = USIService.class.getClassLoader().getResource("/wsdl/USIServiceV2.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(USIService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "/wsdl/USIServiceV2.wsdl");
        }       
        WSDL_LOCATION = url;
    }
