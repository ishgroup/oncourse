...
package ish.oncourse.util.selenium.service.shell.command;

import java.io.File;

/**
 * Build terminal command to convert a React error message from bundle format to a sourceMap format.
 */
