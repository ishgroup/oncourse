...
/**
 * The class was redefined to exclude java script injection in pages of ish enrol application
 */
public class JavaScriptSupportImpl implements JavaScriptSupport
{
	...
	/**
	 * The method should be empty to exclude injection  these Tapestry java scripts to a page:
	 *
