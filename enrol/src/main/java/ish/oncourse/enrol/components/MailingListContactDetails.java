...
public class MailingListContactDetails {
   ...
   public boolean getShowAddress() {
	   String require = preferenceController.getRequireContactAddressMailingList();
   ...
   public boolean getShowSuburb() {
	   String require = preferenceController.getRequireContactSuburbMailingList();
	   if ("Show".equals(require) || "Required".equals(require) || require == null) {
		   return true;
	   }
	   return false;
   ...
   public boolean getShowState() {
	   String require = preferenceController.getRequireContactStateMailingList();
	   if ("Show".equals(require) || "Required".equals(require) || require == null) {
		   return true;
	   }
	   return false;
   ...
   public boolean getShowPostcode() {
	   String require = preferenceController.getRequireContactPostcodeMailingList();
	   if ("Show".equals(require) || "Required".equals(require) || require == null) {
		   return true;
	   }
	   return false;
   ...
   public boolean getShowHomePhone() {
	   String require = preferenceController.getRequireContactHomePhoneMailingList();
	   if ("Show".equals(require) || "Required".equals(require) || require == null) {
		   return true;
	   }
	   return false;
   ...
   public boolean getShowBusinessPhone() {
	   String require = preferenceController.getRequireContactBusinessPhoneMailingList();
	   if ("Show".equals(require) || "Required".equals(require) || require == null) {
		   return true;
	   }
	   return false;
   ...
   public boolean getShowFax() {
	   String require = preferenceController.getRequireContactFaxMailingList();
	   if ("Show".equals(require) || "Required".equals(require) || require == null) {
		   return true;
	   }
	   return false;
   ...
   public boolean getShowMobile() {
	   String require = preferenceController.getRequireContactMobileMailingList();
	   if ("Show".equals(require) || "Required".equals(require) || require == null) {
		   return true;
	   }
	   return false;
   ...
   public boolean getShowDateOfBirth() {
	   String require = preferenceController.getRequireContactDateOfBirthMailingList();
	   if ("Show".equals(require) || "Required".equals(require) || require == null) {
		   return true;
	   }
	   return false;
