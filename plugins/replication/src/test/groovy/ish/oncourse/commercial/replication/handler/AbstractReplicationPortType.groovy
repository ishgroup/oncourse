...
class AbstractReplicationPortType implements ReplicationPortType {
	...
	/**
	 * @see ish.oncourse.webservices.soap.v25.ReplicationPortType#sendRecords(ish.oncourse.webservices.v25.stubs.replication.ReplicationRecords)
	 */
	@Override
	...
	/**
	 * @see ish.oncourse.webservices.soap.v25.ReplicationPortType#getRecords()
	 */
	@Override
	...
	/**
	 * @see ish.oncourse.webservices.soap.v25.ReplicationPortType#sendResults(ish.oncourse.webservices.v25.stubs.replication.ReplicationResult)
	 */
	@Override
	...
	/**
	 * @see ish.oncourse.webservices.soap.v25.ReplicationPortType#confirmExecution(java.lang.Long, java.lang.String)
	 */
	@Override
	...
	/**
	 * @see ish.oncourse.webservices.soap.v25.ReplicationPortType#getInstructions()
	 */
	@Override
	...
	/**
	 * @throws ish.oncourse.webservices.soap.v25.AuthFailure
	 * @see ish.oncourse.webservices.soap.v25.ReplicationPortType#authenticate(java.lang.String, long)
	 */
	@Override
	...
	/**
	 * @see ish.oncourse.webservices.soap.v25.ReplicationPortType#getUnreplicatedEntities()
	 */
	@Override
