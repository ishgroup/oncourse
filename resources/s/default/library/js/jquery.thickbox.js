...
// Fetch our variables
jQuery.getScript("/Head/jsVars");
	
var tb_pathToImage = WSRBaseURL + "/library/images/loadingAnimation.gif";

// fixes the fact that ie7 now reports itself as MSIE 6.0 compatible
// See http://jamazon.co.uk/web/2008/03/17/thickbox-31-ie7-positioning-bug/ (-cll)
$.browser.msie6 = 
        $.browser.msie 
