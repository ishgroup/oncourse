...
CREATE  TABLE IF NOT EXISTS `w2_college`.`LicenseFee` (
  ...
  `billingMonth` INT(11) DEFAULT NULL ,
  PRIMARY KEY (`id`) ,
...
CREATE  TABLE IF NOT EXISTS `w2_college`.`WillowUser` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT ,
  `collegeId` BIGINT(20) NULL DEFAULT NULL,
  `email` VARCHAR(128) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL NOT NULL ,
  `firstName` VARCHAR(128) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL NOT NULL ,
  `lastName` VARCHAR(128) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL NOT NULL ,
  `password` VARCHAR(16) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `w2_college`.`QueuedTransaction` (
  ...
  `modified` DATETIME NULL DEFAULT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `QueuedTransaction_ibfk_1` (`collegeId` ASC) ,
  CONSTRAINT `QueuedTransaction_ibfk_1`
    FOREIGN KEY (`collegeId` )
    REFERENCES `w2_college`.`College` (`id` ))
ENGINE = InnoDB
...
CREATE  TABLE IF NOT EXISTS `w2_college`.`QueuedRecord` (
  ...
  `entityWillowId` BIGINT(20) NULL DEFAULT NULL ,
  `action` ENUM('Create', 'Update', 'Delete') CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL ,
  `numberOfAttempts` INT(11) NULL DEFAULT NULL ,
  ...
  CONSTRAINT `QueuedRecord_ibfk_1`
    FOREIGN KEY (`collegeId` )
    REFERENCES `w2_college`.`College` (`id` ),
  CONSTRAINT `QueuedRecord_ibfk_2`
...
`id`, `collegeId`, `email`,
  ...
  `isActive`, `lastLogin`,  `lastFailedLogin`,
  `failedLoginCount`,  `created`,  `modified`) VALUES ( 10000,
  NULL, "dev@ish.com.au", "Dev", "Jones", "test", 
  1, NULL, NULL,
  0, CURRENT_DATE, CURRENT_DATE);

alter table Taggable add index idIdentfIndx(entityWillowId, entityIdentifier);
