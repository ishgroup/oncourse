...
public class stagingMigratePreferences {
    

public static void main(String[] args) {
	Connection conn = null;
	String url = "jdbc:mysql://10.100.33.2:3306/";
	String dbName = "w2staging_college";
	String driver = "com.mysql.jdbc.Driver";
	String userName = "stagingrestore"; 
	String password = "neiDu9Oi";
