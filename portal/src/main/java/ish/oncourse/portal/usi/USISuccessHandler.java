 ...
 */
public class USISuccessHandler extends AbstractStepHandler {
    ...
    public Result getValue() {
        if (result.isEmpty()) {
            ...
            addValue(Value.valueOf(Contact.DATE_OF_BIRTH.getName(), (date != null ?
                    ...
                    null)));
            addValue(Value.valueOf(Contact.GIVEN_NAME.getName(), contact.getGivenName()));
            addValue(Value.valueOf(Contact.FAMILY_NAME.getName(), contact.getFamilyName()));
  ...
  @Override
    ...
    public USISuccessHandler handle(Map<String, Value> input) {
