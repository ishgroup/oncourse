...
interface AccessRights {
     ...
     */
    public static final Request.Method[] DIR_READ_ONLY_AND_ADD_CHILD = [GET, HEAD, OPTIONS, PROPFIND, MKCOL, PUT, POST, MOVE]

    /**
     * Allowed request methods for read only dir (like /cms/webdav)
     */
    public static final Request.Method[] DIR_READ_ONLY = [GET, HEAD, OPTIONS, PROPFIND]
}