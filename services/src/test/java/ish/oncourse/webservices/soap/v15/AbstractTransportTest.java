...
public abstract class AbstractTransportTest {
    ...
    protected PaymentPortType getPaymentPortType() {
        return getPortType("/services/v15/payment",  new QName("http://repl.v15.soap.webservices.oncourse.ish/", "ReplicationService"), PaymentPortType.class);
    }



    protected ReplicationPortType getReplicationPortType() {
        return getPortType("/services/v15/replication", new QName("http://repl.v15.soap.webservices.oncourse.ish/", "ReplicationService") , ReplicationPortType.class);
    }
