...
public class ReplicationPortTypeTest extends ServiceTest {
	...
	@Test
	public void testV25GetRecordsSuccess() throws Exception {
		testGetRecordsSuccess(SupportedVersions.V25);
	}
	
	@Test
	public void testV25SendRecordsFailToDelete() throws Exception {
		DatabaseConnection dbUnitConnection = new DatabaseConnection(getDataSource().getConnection(), null);
		IReplicationService service = getService(IReplicationService.class);
		...
		ish.oncourse.webservices.v25.stubs.replication.DeletedStub contactDeleteStub = new ish.oncourse.webservices.v25.stubs.replication.DeletedStub();
		contactDeleteStub.setWillowId(1l);
		contactDeleteStub.setAngelId(250l);
		contactDeleteStub.setEntityIdentifier("Contact");
		ish.oncourse.webservices.v25.stubs.replication.DeletedStub studentDeleteStub = new ish.oncourse.webservices.v25.stubs.replication.DeletedStub();
		studentDeleteStub.setWillowId(200l);
		studentDeleteStub.setAngelId(1200l);
		studentDeleteStub.setEntityIdentifier("Student");
		GenericTransactionGroup group = PortHelper.createTransactionGroup(SupportedVersions.V25);
		group.getGenericAttendanceOrBinaryInfo().add(contactDeleteStub);
		group.getGenericAttendanceOrBinaryInfo().add(studentDeleteStub);
		GenericReplicationRecords records = PortHelper.createReplicationRecords(SupportedVersions.V25);
	...
	@Test
	public void testV25SendRecordsCreateAndDeleteSucess() throws Exception {
		...
		ish.oncourse.webservices.v25.stubs.replication.CourseClassStub rootStub = new ish.oncourse.webservices.v25.stubs.replication.CourseClassStub();
	...
	@Test
	public void testV25SendResult() throws Exception {
		testSendResult(SupportedVersions.V25, false);
	}
	
	@Test
	public void testV25SendResultWithConcurentDelete() throws Exception {
		testSendResult(SupportedVersions.V25, true);
	}
}
