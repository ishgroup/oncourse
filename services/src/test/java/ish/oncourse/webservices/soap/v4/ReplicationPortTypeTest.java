...
public class ReplicationPortTypeTest extends ServiceTest {
	...
	@Test
	public void testV13GetRecordsSuccess() throws Exception {
		testGetRecordsSuccess(SupportedVersions.V13);
	}
	
	@Test
	public void testV13SendRecordsFailToDelete() throws Exception {
		DatabaseConnection dbUnitConnection = new DatabaseConnection(getDataSource("jdbc/oncourse").getConnection(), null);		
		IReplicationService service = getService(IReplicationService.class);
		...
		ish.oncourse.webservices.v13.stubs.replication.DeletedStub contactDeleteStub = new ish.oncourse.webservices.v13.stubs.replication.DeletedStub();
		contactDeleteStub.setWillowId(1l);
		contactDeleteStub.setAngelId(250l);
		contactDeleteStub.setEntityIdentifier("Contact");
		ish.oncourse.webservices.v13.stubs.replication.DeletedStub studentDeleteStub = new ish.oncourse.webservices.v13.stubs.replication.DeletedStub();
		...
		GenericReplicationRecords records = PortHelper.createReplicationRecords(SupportedVersions.V13);
	...
	@Test
	public void testV13SendRecordsCreateAndDeleteSucess() throws Exception {
		...
		ish.oncourse.webservices.v13.stubs.replication.CourseClassStub rootStub = new ish.oncourse.webservices.v13.stubs.replication.CourseClassStub();
	...
	@Test
	public void testV13SendResult() throws Exception {
		testSendResult(SupportedVersions.V13, false);
	}
	
	@Test
	public void testV13SendResultWithConcurentDelete() throws Exception {
		testSendResult(SupportedVersions.V13, true);
	}
}
