...
public abstract class AbstractTransportTest {
    ...
    protected PaymentPortType getPaymentPortType() {
        return getPortType("/services/v10/payment",  new QName("http://repl.v10.soap.webservices.oncourse.ish/", "ReplicationService"), PaymentPortType.class);
    }



    protected ReplicationPortType getReplicationPortType() {
        return getPortType("/services/v10/replication", new QName("http://repl.v10.soap.webservices.oncourse.ish/", "ReplicationService") , ReplicationPortType.class);
    }
