...
public abstract class AbstractTransportTest {
    ...
    public static final String PACKAGE_NAME_REPLICATION_STUBS = "ish.oncourse.webservices.v16.stubs.replication";
    ...
    protected PaymentPortType getPaymentPortType() {
        return getPortType("/services/v16/payment",  new QName("http://repl.v16.soap.webservices.oncourse.ish/", "ReplicationService"), PaymentPortType.class);
    }



    protected ReplicationPortType getReplicationPortType() {
        return getPortType("/services/v16/replication", new QName("http://repl.v16.soap.webservices.oncourse.ish/", "ReplicationService") , ReplicationPortType.class);
    }
