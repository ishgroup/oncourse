...
import ish.oncourse.webservices.v8.stubs.replication.InstructionStub;
import ish.oncourse.webservices.v8.stubs.replication.ReplicationRecords;
import ish.oncourse.webservices.v8.stubs.replication.ReplicationResult;
...
public class WebServicesTransportTest extends AbstractTransportTest {
	...
	private PaymentPortType getPortType() throws JAXBException {
		return getPaymentPortType("wsdl/v8_replication.wsdl", "/services/v8/payment");
	}

	private ReplicationPortType getReplicationPortType() throws JAXBException {
		return getReplicationPortType("wsdl/v8_replication.wsdl", "/services/v8/replication");
	}
