package ish.oncourse.webservices.soap.v13.stubs;
...
/**
 * Stub compatibility check for v13 stubs.
 * This test should care of stub health till v13 stubs will be supported.
...
public class StubsCompatibilityCheckTest extends ServiceTest {
	...
	private void testCollectorDefinition(final Object stub, final List<ReplicationStubFieldParameter> parameters) {
		...
		for (final PropertyDescriptor descriptor : descriptors) {
			...
			// and attendanceOrBinaryDataOrBinaryInfo because in v13 this property replaced with replicationStub
