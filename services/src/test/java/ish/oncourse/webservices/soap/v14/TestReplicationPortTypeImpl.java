...
import ish.oncourse.webservices.v14.stubs.replication.ReplicatedRecord;
...
import ish.oncourse.webservices.v14.stubs.replication.SiteStub;
import ish.oncourse.webservices.v14.stubs.replication.TransactionGroup;
import ish.oncourse.webservices.v14.stubs.replication.UnreplicatedEntitiesStub;
...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v14.ReplicationPortType", serviceName = "ReplicationService", portName = "ReplicationPort", targetNamespace = "http://repl.v14.soap.webservices.oncourse.ish/")
public class TestReplicationPortTypeImpl implements ReplicationPortType {

	@Override
	public ReplicationResult sendRecords(@WebParam(partName = "records", name = "records", targetNamespace = "") ReplicationRecords replicationRecords) throws ish.oncourse.webservices.soap.v14.ReplicationFault {
	...
	@Override
	public ReplicationRecords getRecords() throws ish.oncourse.webservices.soap.v14.ReplicationFault {
	...
	@Override
	public TransactionGroup getRecordByInstruction(String s) throws ish.oncourse.webservices.soap.v14.ReplicationFault {
		TransactionGroup transactionGroup = null;
		try {
			transactionGroup = AbstractTransportTest.createTransactionGroupWithAllStubs();
		} catch (Throwable throwable) {
