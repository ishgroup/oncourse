...
public class V15TestEnv {
    ...
    private V15TransportConfig transportConfig;
    ...
    public V15TransportConfig getTransportConfig() {
    ...
    public static class TestCase {
        ...
        public TestCase(V15TestEnv testEnv, BiConsumer<GenericTransactionGroup, GenericParametersMap> fillStubs,
