...
import ish.oncourse.webservices.v14.stubs.replication.ReplicationStub;
...
public abstract class AbstractTransportTest extends AbstractServerTest {
	...
	public static final String PACKAGE_NAME_REPLICATION_STUBS = "ish.oncourse.webservices.v14.stubs.replication";
	...
	protected PaymentPortType getPaymentPortType() {
		return getPortType("/services/v14/payment", new QName("http://repl.v14.soap.webservices.oncourse.ish/", "ReplicationService"), PaymentPortType.class);
	}


	protected ReplicationPortType getReplicationPortType() {
		return getPortType("/services/v14/replication", new QName("http://repl.v14.soap.webservices.oncourse.ish/", "ReplicationService"), ReplicationPortType.class);
	}
