...
import ish.oncourse.webservices.v15.stubs.replication.ReplicatedRecord;
...
import ish.oncourse.webservices.v15.stubs.replication.SiteStub;
...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v15.ReplicationPortType", serviceName = "ReplicationService", portName = "ReplicationPort", targetNamespace = "http://repl.v15.soap.webservices.oncourse.ish/")
public class TestReplicationPortTypeImpl implements ReplicationPortType {

	@Override
	public ReplicationResult sendRecords(@WebParam(partName = "records", name = "records", targetNamespace = "") ReplicationRecords replicationRecords) throws ish.oncourse.webservices.soap.v15.ReplicationFault {
	...
	@Override
	public ReplicationRecords getRecords() throws ish.oncourse.webservices.soap.v15.ReplicationFault {
	...
	@Override
	public TransactionGroup getRecordByInstruction(String s) throws ish.oncourse.webservices.soap.v15.ReplicationFault {
		TransactionGroup transactionGroup = null;
		try {
			transactionGroup = AbstractTransportTest.createTransactionGroupWithAllStubs();
		} catch (Throwable throwable) {
