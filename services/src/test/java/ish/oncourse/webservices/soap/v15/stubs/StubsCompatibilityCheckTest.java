package ish.oncourse.webservices.soap.v15.stubs;
...
/**
 * Stub compatibility check for v15 stubs.
 * This test should care of stub health till v15 stubs will be supported.
...
public class StubsCompatibilityCheckTest extends ServiceTest {
	...
	private void testCollectorDefinition(final Object stub, final List<ReplicationStubFieldParameter> parameters) {
		...
		for (final PropertyDescriptor descriptor : descriptors) {
			...
			// and attendanceOrBinaryDataOrBinaryInfo because in v15 this property replaced with replicationStub
