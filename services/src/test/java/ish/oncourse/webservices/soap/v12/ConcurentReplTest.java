...
import ish.oncourse.webservices.v12.stubs.replication.ContactStub;
import ish.oncourse.webservices.v12.stubs.replication.ArticleStub;
import ish.oncourse.webservices.v12.stubs.replication.EnrolmentStub;
import ish.oncourse.webservices.v12.stubs.replication.InvoiceLineStub;
import ish.oncourse.webservices.v12.stubs.replication.InvoiceStub;
import ish.oncourse.webservices.v12.stubs.replication.MembershipStub;
import ish.oncourse.webservices.v12.stubs.replication.PaymentInLineStub;
import ish.oncourse.webservices.v12.stubs.replication.PaymentInStub;
...
import ish.oncourse.webservices.v12.stubs.replication.StudentStub;
...
public class ConcurentReplTest extends QEPaymentProcessTest {
	...
	protected void fillv12ReplStubs(GenericTransactionGroup transaction) {
		List<GenericReplicationStub> stubs = transaction.getGenericAttendanceOrBinaryDataOrBinaryInfo();
		final Money hundredDollars = new Money("100.00");
		final Date current = new Date();
