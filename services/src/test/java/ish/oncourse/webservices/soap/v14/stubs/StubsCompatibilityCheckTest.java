package ish.oncourse.webservices.soap.v14.stubs;
...
/**
 * Stub compatibility check for v14 stubs.
 * This test should care of stub health till v14 stubs will be supported.
...
public class StubsCompatibilityCheckTest extends ServiceTest {
	...
	private void testCollectorDefinition(final Object stub, final List<ReplicationStubFieldParameter> parameters) {
		...
		for (final PropertyDescriptor descriptor : descriptors) {
			...
			// and attendanceOrBinaryDataOrBinaryInfo because in v14 this property replaced with replicationStub
