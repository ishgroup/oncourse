 ...
 */
public class V14TransportConfig extends TransportConfig<TransactionGroup, ParametersMap, ReplicationStub, ReferenceStub, ReferencePortType, ReplicationPortType, PaymentPortType> {
