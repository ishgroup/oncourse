...
import ish.oncourse.webservices.soap.v18.QEPaymentProcess5_6CasesGUITest;
...
import ish.oncourse.webservices.v18.stubs.replication.VoucherStub;
...
public class QEPreviouslyKeepEnrolmentWithNewInvoiceTest extends QEPaymentProcess5_6CasesGUITest {
	...
	public void before() throws Exception {
		testEnv = new V18TestEnv(DEFAULT_DATASET_XML, null);
		testEnv.start();
	}
