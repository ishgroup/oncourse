...
import ish.oncourse.webservices.soap.v25.PaymentPortType;
...
public class V25TransportConfig extends TransportConfig<
    ...
    public V25TransportConfig(TestEnv testEnv) {
        this.serverURI(testEnv.getURI());
        this.replicationVersion(SupportedVersions.V25);
