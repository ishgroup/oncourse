...
import ish.oncourse.webservices.v13.stubs.replication.ArticleStub;
import ish.oncourse.webservices.v13.stubs.replication.EnrolmentStub;
import ish.oncourse.webservices.v13.stubs.replication.InvoiceLineStub;
import ish.oncourse.webservices.v13.stubs.replication.InvoiceStub;
import ish.oncourse.webservices.v13.stubs.replication.MembershipStub;
import ish.oncourse.webservices.v13.stubs.replication.PaymentInLineStub;
import ish.oncourse.webservices.v13.stubs.replication.PaymentInStub;
...
import ish.oncourse.webservices.v13.stubs.replication.StudentStub;
import ish.oncourse.webservices.v13.stubs.replication.TransactionGroup;
import ish.oncourse.webservices.v13.stubs.replication.VoucherStub;
...
public class ConcurentReplTest extends QEPaymentProcessTest {
	...
	protected void fillv13PaymentStubs(GenericTransactionGroup transaction, GenericParametersMap parametersMap) {
	...
	protected void fillv13ReplStubs(GenericTransactionGroup transaction) {
		List<GenericReplicationStub> stubs = transaction.getGenericAttendanceOrBinaryDataOrBinaryInfo();
		final Money hundredDollars = new Money("100.00");
		final Date current = new Date();
