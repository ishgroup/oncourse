...
import ish.oncourse.webservices.soap.v18.QEVoucherRedeemWithMoneyPaymentGUITest;
import ish.oncourse.webservices.util.GenericParametersMap;
import ish.oncourse.webservices.util.GenericReplicationStub;
import ish.oncourse.webservices.util.GenericTransactionGroup;
import ish.oncourse.webservices.v18.stubs.replication.VoucherPaymentInStub;

import java.util.Date;
import java.util.List;

public abstract class QECourseVoucherRedeemWithMoneyPaymentTest extends QEVoucherRedeemWithMoneyPaymentGUITest {

	protected void preparePaymentStructureForCourseVoucherAndMoneyPayment(GenericTransactionGroup transaction, GenericParametersMap parametersMap) {
