package ish.oncourse.webservices.soap.v7.auth;
...
import ish.oncourse.webservices.soap.v18.ReplicationPortTypeImpl;
import ish.oncourse.webservices.v18.stubs.replication.ErrorCode;
...
public class AuthenticationPortTypeTest extends ServiceTest {
	...
	public void testAuthenticateSuccess() throws Exception {
		InputStream st = getClass().getClassLoader().getResourceAsStream("ish/oncourse/webservices/soap/v7/auth/authDataSet.xml");
