...
import ish.oncourse.webservices.v12.stubs.replication.*;
...
/**
 * Stub compatibility check for v12 stubs.
 * This test should care of stub health till v12 stubs will be supported.
...
public class StubsCompatibilityCheckTest extends ServiceTest {
	...
	private void testCollectorDefinition(final Object stub, final List<ReplicationStubFieldParameter> parameters) {
		...
		for (final PropertyDescriptor descriptor : descriptors) {
			...
			// and attendanceOrBinaryDataOrBinaryInfo because in v12 this property replaced with replicationStub
