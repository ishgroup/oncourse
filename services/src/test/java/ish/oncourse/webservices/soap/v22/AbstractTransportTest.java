...
import ish.oncourse.webservices.v22.stubs.replication.ReplicationStub;
...
public abstract class AbstractTransportTest extends AbstractServerTest {
    ...
    public static final String PACKAGE_NAME_REPLICATION_STUBS = "ish.oncourse.webservices.v22.stubs.replication";
    ...
    protected PaymentPortType getPaymentPortType() {
        return getPortType("/services/v22/payment",  new QName("http://repl.v22.soap.webservices.oncourse.ish/", "ReplicationService"), PaymentPortType.class);
    }



    protected ReplicationPortType getReplicationPortType() {
        return getPortType("/services/v22/replication", new QName("http://repl.v22.soap.webservices.oncourse.ish/", "ReplicationService") , ReplicationPortType.class);
    }
