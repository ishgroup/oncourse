...
public abstract class RealWSTransportTest extends AbstractTransportTest {
	...
	protected static final String PAYMENT_ENDPOINT_PATH = TestServer.DEFAULT_CONTEXT_PATH + "/v8/payment";
	protected static final String REPLICATION_ENDPOINT_PATH = TestServer.DEFAULT_CONTEXT_PATH + "/v8/replication";
	protected static final String REPLICATION_WSDL = "wsdl/v8_replication.wsdl";
