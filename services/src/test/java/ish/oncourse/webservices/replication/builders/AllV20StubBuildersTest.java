...
import ish.oncourse.webservices.replication.v20.builders.*;
import ish.oncourse.webservices.v20.stubs.replication.ContactStub;
...
public class AllV20StubBuildersTest extends AbstractAllStubBuildersTest {
    ...
    public void testConcessionTypeStubBuilder() {
        this.testStubBuilder(ConcessionType.class, new ConcessionTypeStubBuilder(), "createdBy");
    }
    ...
    public void testInvoiceStubBuilder() {
        this.testStubBuilder(Invoice.class, (AbstractWillowStubBuilder) new InvoiceStubBuilder(), "status");
    }
    ...
    public void testCustomFieldTypeStubBuilder() {
        this.testStubBuilder(CustomFieldType.class, new CustomFieldTypeStubBuilder(), "dataType");
    }
    ...
    @Test
    public void testCourseClassPaymentPlanLineStubBuilder() {
        this.testStubBuilder(CourseClassPaymentPlanLine.class, new CourseClassPaymentPlanLineStubBuilder());
    }
    ...
    public void testFieldConfigurationStubBuilder() {
        this.testStubBuilder(FieldConfiguration.class, new FieldConfigurationStubBuilder(), "createdBy");
    }
    ...
    public void testFieldConfigurationSchemeStubBuilder() {
        this.testStubBuilder(FieldConfigurationScheme.class, new FieldConfigurationSchemeStubBuilder(), "createdBy");
    }
