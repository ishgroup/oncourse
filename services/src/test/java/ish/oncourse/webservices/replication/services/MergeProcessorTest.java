...
import static ish.oncourse.webservices.util.SupportedVersions.V18;
import static ish.oncourse.webservices.v18.stubs.replication.Status.SUCCESS;
...
public class MergeProcessorTest extends ServiceTest {
	...
	public void processMergeTransaction() {
		...
		GenericTransactionGroup transactionGroup = PortHelper.createTransactionGroup(V18);
