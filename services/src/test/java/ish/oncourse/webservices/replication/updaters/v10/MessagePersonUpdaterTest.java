...
import ish.oncourse.webservices.replication.v10.updaters.MessagePersonUpdater;
import ish.oncourse.webservices.soap.ReplicationTestModule;
import ish.oncourse.webservices.v10.stubs.replication.MessagePersonStub;
...
public class MessagePersonUpdaterTest extends ServiceTest {
	private static Logger logger = LogManager.getLogger(MessagePersonUpdaterTest.class.getName());
