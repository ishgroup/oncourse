...
import ish.oncourse.webservices.v24.stubs.replication.DeletedStub;
...
public class TransactionGroupProcessorTestUtils {
    ...
    public static ish.oncourse.webservices.v24.stubs.replication.ContactStub generateContactV24Stub(Long angelId,
                                                                                              Long willowId,
                                                                                              String givenName,
                                                                                              String familyName){
        ish.oncourse.webservices.v24.stubs.replication.ContactStub stub = new ContactStub();
    ...
    public static ish.oncourse.webservices.v24.stubs.replication.DeletedStub generateDeleteV24Stub(String entityIdentifier,
                                                                                                   Long angelId,
                                                                                                   Long willowId){
        ish.oncourse.webservices.v24.stubs.replication.DeletedStub stub = new DeletedStub();
        stub.setAngelId(angelId);
        stub.setWillowId(willowId);
    ...
    public static ish.oncourse.webservices.v24.stubs.replication.ContactDuplicateStub generateContactDuplicateV17Stub(Long angelId,
                                                                                                                Long willowId,
                                                                                                                Long contactToUpdateAngelId,
                                                                                                                Long contactToDeleteAngelId,
                                                                                                                Long contactToDeleteWillowId){
        ish.oncourse.webservices.v24.stubs.replication.ContactDuplicateStub stub = new ContactDuplicateStub();
        stub.setAngelId(angelId);
        stub.setWillowId(willowId);
