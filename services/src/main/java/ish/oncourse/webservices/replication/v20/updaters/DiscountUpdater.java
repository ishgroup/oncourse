...
import ish.oncourse.webservices.v20.stubs.replication.DiscountStub;
...
public class DiscountUpdater extends AbstractWillowUpdater<DiscountStub, Discount> {
	...
	protected void  updateEntity(DiscountStub stub, Discount entity, RelationShipCallback callback) {
		...
		entity.setMinEnrolments(stub.getMinEnrolments());
		...
		entity.setLimitPreviousEnrolment(stub.getLimitPreviousEnrolment() != null ? stub.getLimitPreviousEnrolment() : false);
	}
}
