...
public class StudentStubBuilder extends
		AbstractWillowStubBuilder<Student, StudentStub> {
	...
	protected StudentStub createFullStub(Student entity) {
		...
		if (entity.getDisabilityType() != null) {
			stub.setDisabilityType(entity.getDisabilityType()
					.getDatabaseValue());
		}
		else {
		...
		if (entity.getEnglishProficiency() != null) {
			stub.setEnglishProficiency(entity.getEnglishProficiency()
					.getDatabaseValue());
		}
		else {
		...
		if (entity.getHighestSchoolLevel() != null) {
			stub.setHighestSchoolLevel(entity.getHighestSchoolLevel()
					.getDatabaseValue());
		}
		else {
		...
		if (entity.getIndigenousStatus() != null) {
			stub.setIndigenousStatus(entity.getIndigenousStatus()
					.getDatabaseValue());
		}
		else {
		...
		stub.setLanguageHomeId((entity.getLanguageHome() != null) ? entity
				.getLanguageHome().getId() : null);
		
		stub.setLanguageId((entity.getLanguage() != null) ? entity
				.getLanguage().getId() : null);
		...
		if (entity.getPriorEducationCode() != null) {
			stub.setPriorEducationCode(entity.getPriorEducationCode()
					.getDatabaseValue());
		}
		else {
