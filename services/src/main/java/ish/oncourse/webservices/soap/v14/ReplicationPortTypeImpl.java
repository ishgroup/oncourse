...
import ish.oncourse.webservices.v14.stubs.replication.FaultReason;
...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v14.ReplicationPortType", serviceName = "ReplicationService",
		portName = "ReplicationPort", targetNamespace = "http://repl.v14.soap.webservices.oncourse.ish/")
public class ReplicationPortTypeImpl implements ReplicationPortType {
	...
	public List<InstructionStub> getInstructions() {
		return PortHelper.convertV14InstructionsList(instructionService.getInstructions(SupportedVersions.V14));
	}
	...
	public ReplicationRecords getRecords() throws ReplicationFault {
		try {
			return PortHelper.getV14ReplicationRecords(replicationService.getRecords(SupportedVersions.V14));
	...
	public ReplicationResult sendRecords(ReplicationRecords replicationRecords) throws ReplicationFault {
		try {
			return PortHelper.getV14ReplicationResult(replicationService.sendRecords(replicationRecords));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
	...
	public TransactionGroup getRecordByInstruction(String s) throws ReplicationFault {
		try {
			return PortHelper.getV14TransactionGroup(replicationService.getRecordByInstruction(s, SupportedVersions.V14));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
