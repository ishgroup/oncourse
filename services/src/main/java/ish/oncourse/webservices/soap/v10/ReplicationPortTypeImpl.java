...
import ish.oncourse.webservices.v10.stubs.replication.ErrorCode;
import ish.oncourse.webservices.v10.stubs.replication.FaultReason;
...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v10.ReplicationPortType", serviceName = "ReplicationService",
		portName = "ReplicationPort", targetNamespace = "http://repl.v10.soap.webservices.oncourse.ish/")
public class ReplicationPortTypeImpl implements ReplicationPortType {
	...
	public List<InstructionStub> getInstructions() {
		return PortHelper.convertV10InstructionsList(instructionService.getInstructions(SupportedVersions.V10));
	}
	...
	public ReplicationRecords getRecords() throws ReplicationFault {
		try {
			return PortHelper.getV10ReplicationRecords(replicationService.getRecords(SupportedVersions.V10));
	...
	public ReplicationResult sendRecords(ReplicationRecords replicationRecords) throws ReplicationFault {
		try {
			return PortHelper.getV10ReplicationResult(replicationService.sendRecords(replicationRecords));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
