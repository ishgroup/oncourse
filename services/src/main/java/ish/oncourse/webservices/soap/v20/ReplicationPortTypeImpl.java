...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v20.ReplicationPortType", serviceName = "ReplicationService",
		portName = "ReplicationPort", targetNamespace = "http://repl.v20.soap.webservices.oncourse.ish/")
public class ReplicationPortTypeImpl implements ReplicationPortType {
	...
	public List<InstructionStub> getInstructions() {
		return PortHelper.convertV20InstructionsList(instructionService.getInstructions(SupportedVersions.V20));
	}
	...
	public ReplicationRecords getRecords() throws ReplicationFault {
		try {
			return PortHelper.getV20ReplicationRecords(replicationService.getRecords(SupportedVersions.V20));
	...
	public ReplicationResult sendRecords(ReplicationRecords replicationRecords) throws ReplicationFault {
		try {
			return PortHelper.getV20ReplicationResult(replicationService.sendRecords(replicationRecords));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
	...
	public TransactionGroup getRecordByInstruction(String s) throws ReplicationFault {
		try {
			return PortHelper.getV20TransactionGroup(replicationService.getRecordByInstruction(s, SupportedVersions.V20));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
