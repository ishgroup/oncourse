...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v17.ReplicationPortType", serviceName = "ReplicationService",
		portName = "ReplicationPort", targetNamespace = "http://repl.v17.soap.webservices.oncourse.ish/")
public class ReplicationPortTypeImpl implements ReplicationPortType {
	...
	public List<InstructionStub> getInstructions() {
		return PortHelper.convertV17InstructionsList(instructionService.getInstructions(SupportedVersions.V17));
	}
	...
	public ReplicationRecords getRecords() throws ReplicationFault {
		try {
			return PortHelper.getV17ReplicationRecords(replicationService.getRecords(SupportedVersions.V17));
	...
	public ReplicationResult sendRecords(ReplicationRecords replicationRecords) throws ReplicationFault {
		try {
			return PortHelper.getV17ReplicationResult(replicationService.sendRecords(replicationRecords));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
	...
	public TransactionGroup getRecordByInstruction(String s) throws ReplicationFault {
		try {
			return PortHelper.getV17TransactionGroup(replicationService.getRecordByInstruction(s, SupportedVersions.V17));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
