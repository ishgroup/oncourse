...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v24.ReplicationPortType", serviceName = "ReplicationService",
		portName = "ReplicationPort", targetNamespace = "http://repl.v24.soap.webservices.oncourse.ish/")
public class ReplicationPortTypeImpl implements ReplicationPortType {
	...
	public List<InstructionStub> getInstructions() {
		return PortHelper.convertV24InstructionsList(instructionService.getInstructions(SupportedVersions.V24));
	}
	...
	public ReplicationRecords getRecords() throws ReplicationFault {
		try {
			return PortHelper.getV24ReplicationRecords(replicationService.getRecords(SupportedVersions.V24));
	...
	public ReplicationResult sendRecords(ReplicationRecords replicationRecords) throws ReplicationFault {
		try {
			return PortHelper.getV24ReplicationResult(replicationService.sendRecords(replicationRecords));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
	...
	public TransactionGroup getRecordByInstruction(String s) throws ReplicationFault {
		try {
			return PortHelper.getV24TransactionGroup(replicationService.getRecordByInstruction(s, SupportedVersions.V24));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
