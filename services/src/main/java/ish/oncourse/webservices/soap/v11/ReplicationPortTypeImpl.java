...
import ish.oncourse.webservices.soap.v11.AuthFailure;
import ish.oncourse.webservices.soap.v11.ReplicationFault;
import ish.oncourse.webservices.soap.v11.ReplicationPortType;
import ish.oncourse.webservices.util.PortHelper;
import ish.oncourse.webservices.util.SupportedVersions;
import ish.oncourse.webservices.v11.stubs.replication.ErrorCode;
import ish.oncourse.webservices.v11.stubs.replication.FaultReason;
...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v11.ReplicationPortType", serviceName = "ReplicationService",
		portName = "ReplicationPort", targetNamespace = "http://repl.v11.soap.webservices.oncourse.ish/")
public class ReplicationPortTypeImpl implements ReplicationPortType {
	...
	public List<InstructionStub> getInstructions() {
		return PortHelper.convertV11InstructionsList(instructionService.getInstructions(SupportedVersions.V11));
	}
	...
	public ReplicationRecords getRecords() throws ReplicationFault {
		try {
			return PortHelper.getV11ReplicationRecords(replicationService.getRecords(SupportedVersions.V11));
	...
	public ReplicationResult sendRecords(ReplicationRecords replicationRecords) throws ReplicationFault {
		try {
			return PortHelper.getV11ReplicationResult(replicationService.sendRecords(replicationRecords));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
