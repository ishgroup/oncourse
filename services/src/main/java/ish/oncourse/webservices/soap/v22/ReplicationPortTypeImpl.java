...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v22.ReplicationPortType", serviceName = "ReplicationService",
		portName = "ReplicationPort", targetNamespace = "http://repl.v22.soap.webservices.oncourse.ish/")
public class ReplicationPortTypeImpl implements ReplicationPortType {
	...
	public List<InstructionStub> getInstructions() {
		return PortHelper.convertV22InstructionsList(instructionService.getInstructions(SupportedVersions.V22));
	}
	...
	public ReplicationRecords getRecords() throws ReplicationFault {
		try {
			return PortHelper.getV22ReplicationRecords(replicationService.getRecords(SupportedVersions.V22));
	...
	public ReplicationResult sendRecords(ReplicationRecords replicationRecords) throws ReplicationFault {
		try {
			return PortHelper.getV22ReplicationResult(replicationService.sendRecords(replicationRecords));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
	...
	public TransactionGroup getRecordByInstruction(String s) throws ReplicationFault {
		try {
			return PortHelper.getV22TransactionGroup(replicationService.getRecordByInstruction(s, SupportedVersions.V22));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
