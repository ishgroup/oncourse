...
import ish.oncourse.webservices.soap.v13.AuthFailure;
import ish.oncourse.webservices.soap.v13.ReplicationFault;
import ish.oncourse.webservices.soap.v13.ReplicationPortType;
import ish.oncourse.webservices.util.PortHelper;
import ish.oncourse.webservices.util.SupportedVersions;
import ish.oncourse.webservices.v13.stubs.replication.ErrorCode;
import ish.oncourse.webservices.v13.stubs.replication.FaultReason;
import ish.oncourse.webservices.v13.stubs.replication.InstructionStub;
import ish.oncourse.webservices.v13.stubs.replication.ReplicationRecords;
import ish.oncourse.webservices.v13.stubs.replication.ReplicationResult;
import ish.oncourse.webservices.v13.stubs.replication.TransactionGroup;
import ish.oncourse.webservices.v13.stubs.replication.UnreplicatedEntitiesStub;
...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v13.ReplicationPortType", serviceName = "ReplicationService",
		portName = "ReplicationPort", targetNamespace = "http://repl.v13.soap.webservices.oncourse.ish/")
public class ReplicationPortTypeImpl implements ReplicationPortType {
	...
	public List<InstructionStub> getInstructions() {
		return PortHelper.convertV13InstructionsList(instructionService.getInstructions(SupportedVersions.V13));
	}
	...
	public ReplicationRecords getRecords() throws ReplicationFault {
		try {
			return PortHelper.getV13ReplicationRecords(replicationService.getRecords(SupportedVersions.V13));
	...
	public ReplicationResult sendRecords(ReplicationRecords replicationRecords) throws ReplicationFault {
		try {
			return PortHelper.getV13ReplicationResult(replicationService.sendRecords(replicationRecords));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
	...
	public TransactionGroup getRecordByInstruction(String s) throws ReplicationFault {
		try {
			return PortHelper.getV13TransactionGroup(replicationService.getRecordByInstruction(s, SupportedVersions.V13));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
