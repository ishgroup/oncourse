...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v16.ReplicationPortType", serviceName = "ReplicationService",
		portName = "ReplicationPort", targetNamespace = "http://repl.v16.soap.webservices.oncourse.ish/")
public class ReplicationPortTypeImpl implements ReplicationPortType {
	...
	public List<InstructionStub> getInstructions() {
		return PortHelper.convertV16InstructionsList(instructionService.getInstructions(SupportedVersions.V16));
	}
	...
	public ReplicationRecords getRecords() throws ReplicationFault {
		try {
			return PortHelper.getV16ReplicationRecords(replicationService.getRecords(SupportedVersions.V16));
	...
	public ReplicationResult sendRecords(ReplicationRecords replicationRecords) throws ReplicationFault {
		try {
			return PortHelper.getV16ReplicationResult(replicationService.sendRecords(replicationRecords));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
	...
	public TransactionGroup getRecordByInstruction(String s) throws ReplicationFault {
		try {
			return PortHelper.getV16TransactionGroup(replicationService.getRecordByInstruction(s, SupportedVersions.V16));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
