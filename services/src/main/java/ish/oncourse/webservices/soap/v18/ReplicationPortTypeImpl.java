...
import ish.oncourse.webservices.soap.v18.AuthFailure;
import ish.oncourse.webservices.soap.v18.ReplicationFault;
import ish.oncourse.webservices.soap.v18.ReplicationPortType;
...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v18.ReplicationPortType", serviceName = "ReplicationService",
		portName = "ReplicationPort", targetNamespace = "http://repl.v18.soap.webservices.oncourse.ish/")
public class ReplicationPortTypeImpl implements ReplicationPortType {
	...
	public List<InstructionStub> getInstructions() {
		return PortHelper.convertV18InstructionsList(instructionService.getInstructions(SupportedVersions.V18));
	}
	...
	public ReplicationRecords getRecords() throws ReplicationFault {
		try {
			return PortHelper.getV18ReplicationRecords(replicationService.getRecords(SupportedVersions.V18));
	...
	public ReplicationResult sendRecords(ReplicationRecords replicationRecords) throws ReplicationFault {
		try {
			return PortHelper.getV18ReplicationResult(replicationService.sendRecords(replicationRecords));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
	...
	public TransactionGroup getRecordByInstruction(String s) throws ReplicationFault {
		try {
			return PortHelper.getV18TransactionGroup(replicationService.getRecordByInstruction(s, SupportedVersions.V18));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
