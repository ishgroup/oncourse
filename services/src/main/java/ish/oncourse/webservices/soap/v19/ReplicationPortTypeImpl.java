...
import ish.oncourse.webservices.v19.stubs.replication.*;
...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v19.ReplicationPortType", serviceName = "ReplicationService",
		portName = "ReplicationPort", targetNamespace = "http://repl.v19.soap.webservices.oncourse.ish/")
public class ReplicationPortTypeImpl implements ReplicationPortType {
	...
	public List<InstructionStub> getInstructions() {
		return PortHelper.convertV19InstructionsList(instructionService.getInstructions(SupportedVersions.V19));
	}
	...
	public ReplicationRecords getRecords() throws ReplicationFault {
		try {
			return PortHelper.getV19ReplicationRecords(replicationService.getRecords(SupportedVersions.V19));
	...
	public ReplicationResult sendRecords(ReplicationRecords replicationRecords) throws ReplicationFault {
		try {
			return PortHelper.getV19ReplicationResult(replicationService.sendRecords(replicationRecords));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
	...
	public TransactionGroup getRecordByInstruction(String s) throws ReplicationFault {
		try {
			return PortHelper.getV19TransactionGroup(replicationService.getRecordByInstruction(s, SupportedVersions.V19));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
