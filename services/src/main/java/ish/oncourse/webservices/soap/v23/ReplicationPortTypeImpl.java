...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v23.ReplicationPortType", serviceName = "ReplicationService",
		portName = "ReplicationPort", targetNamespace = "http://repl.v23.soap.webservices.oncourse.ish/")
public class ReplicationPortTypeImpl implements ReplicationPortType {
	...
	public List<InstructionStub> getInstructions() {
		return PortHelper.convertV23InstructionsList(instructionService.getInstructions(SupportedVersions.V23));
	}
	...
	public ReplicationRecords getRecords() throws ReplicationFault {
		try {
			return PortHelper.getV23ReplicationRecords(replicationService.getRecords(SupportedVersions.V23));
	...
	public ReplicationResult sendRecords(ReplicationRecords replicationRecords) throws ReplicationFault {
		try {
			return PortHelper.getV23ReplicationResult(replicationService.sendRecords(replicationRecords));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
	...
	public TransactionGroup getRecordByInstruction(String s) throws ReplicationFault {
		try {
			return PortHelper.getV23TransactionGroup(replicationService.getRecordByInstruction(s, SupportedVersions.V23));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
