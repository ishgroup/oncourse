...
@WebService(endpointInterface = "ish.oncourse.webservices.soap.v21.ReplicationPortType", serviceName = "ReplicationService",
		portName = "ReplicationPort", targetNamespace = "http://repl.v21.soap.webservices.oncourse.ish/")
public class ReplicationPortTypeImpl implements ReplicationPortType {
	...
	public List<InstructionStub> getInstructions() {
		return PortHelper.convertV21InstructionsList(instructionService.getInstructions(SupportedVersions.V21));
	}
	...
	public ReplicationRecords getRecords() throws ReplicationFault {
		try {
			return PortHelper.getV21ReplicationRecords(replicationService.getRecords(SupportedVersions.V21));
	...
	public ReplicationResult sendRecords(ReplicationRecords replicationRecords) throws ReplicationFault {
		try {
			return PortHelper.getV21ReplicationResult(replicationService.sendRecords(replicationRecords));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
	...
	public TransactionGroup getRecordByInstruction(String s) throws ReplicationFault {
		try {
			return PortHelper.getV21TransactionGroup(replicationService.getRecordByInstruction(s, SupportedVersions.V21));
		} catch (InternalReplicationFault e) {
			throw createReplicationFaultForException(e);
		}
	}
