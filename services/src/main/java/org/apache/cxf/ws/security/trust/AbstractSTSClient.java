...
// ATTENTION!
// This class replaces original CXF AbstractSTSClient class to skip the addition of SecondaryParameters section 
// to STS SOAP request which is causing an internal error in Vanguard STS service
//
// Source code for this class is taken from cxf-rt-ws-security-2.6.16.jar
// and should be reviewed and updated with each upgrade of CXF dependencies version.
...
public abstract class AbstractSTSClient implements Configurable, InterceptorProvider {
	...
	protected STSResponse issue(
		...
		// The following code is adding SecondaryParameters section to STS request
		// and is commented out since presence of this section in a SOAP request
		// is causing an internal error in Vanguard STS service
