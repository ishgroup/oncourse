...
import ish.oncourse.solr.Constants
...
class ReindexServlet extends GroovyServlet {
    ...
    public static final String REINDEX_PATH = '/ish.reindex'
    ...
    void service(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String collection = request.getParameter(Constants.PARAM_COLLECTION)
        ...
        switch (collection) {
            case SolrCollection.classes.name():
                ...
                String siteKey = request.getParameter(Constants.PARAM_WEB_SITE)
                if (!siteKey) {
