...
class BillingApp {
    ...
    static void main(String[] args) {
        Configuration.configure(S_ROOT, STORAGE_ACCESS_ID, STORAGE_ACCESS_KEY, DEPLOY_SCRIPT_PATH, SVN_URL, SVN_USER, SVN_PASS, BILLING_UPDATE, CLIENT_ID, API_KEY, IPV4_DIAPASON, IPV6_DIAPASON)
