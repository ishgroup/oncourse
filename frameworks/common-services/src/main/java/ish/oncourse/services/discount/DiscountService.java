...
public class DiscountService implements IDiscountService{
	 ...
	 * 
	 * The implementation is brought from angel/client/ish.oncourse.cayenne.Discount.getApplicableDiscounts(CourseClass courseClass)
	 */
	@Override
	public List<Discount> getApplicableDiscounts(CourseClass courseClass) {
		...
		e = e.andExp(ExpressionFactory.greaterExp(Discount.VALID_TO_PROPERTY, now).orExp(ExpressionFactory.matchExp(Discount.VALID_TO_PROPERTY, null)));
		e = e.andExp(ExpressionFactory.lessExp(Discount.VALID_FROM_PROPERTY, now).orExp(ExpressionFactory.matchExp(Discount.VALID_FROM_PROPERTY, null)));
	...
	/**
	 * {@inheritDoc}
	 * @see ish.oncourse.services.discount.IDiscountService#chooseDiscounts(java.util.List, ish.oncourse.model.CourseClass)
	 * The processing of combined/notToCombine discounts is based on angel/client/ish.oncourse.cayenne.InvoiceLine.updateDiscount()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see ish.oncourse.services.discount.IDiscountService#discountedFeeExTax(java.util.List, ish.oncourse.model.CourseClass)
	 */
	@Override
	public Money discountedFeeExTax(List<Discount> discounts, CourseClass aClass) {
		Money feeExGst = aClass.getFeeExGst();
		Money result = aClass.getFeeExGst().subtract(discountValueForList(chooseDiscounts(discounts, aClass), feeExGst));
		return result;
	}
	...
	/**
	 * {@inheritDoc}
	 * @see ish.oncourse.services.discount.IDiscountService#discountedFeeIncTax(java.util.List, ish.oncourse.model.CourseClass)
	 */
	@Override
	public Money discountedFeeIncTax(List<Discount> discounts, CourseClass aClass) {
		Money feeIncGst = aClass.getFeeIncGst();
		Money result = aClass.getFeeIncGst().subtract(discountValueForList(chooseDiscounts(discounts, aClass), feeIncGst));
		return result;
	}
	...
	/**
	 * {@inheritDoc}
	 * @see ish.oncourse.services.discount.IDiscountService#discountValueForList(java.util.List, ish.math.Money)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see ish.oncourse.services.discount.IDiscountService#discountValueForListFiltered(java.util.List, ish.oncourse.model.CourseClass)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see ish.oncourse.services.discount.IDiscountService#discountValue(ish.oncourse.model.Discount, ish.math.Money)
	 */
	@Override
