...
/**
 * The {@code MoneyManager} class provides functionality to manage the configuration of
...
public class MoneyManager {
    ...
    /**
     * By default, system {@link MoneyContext} is used for the {@link Money} type.
     ...
     */
    static volatile MoneyContext systemContext = MoneyContextFactory.DEFAULT_MONEY_CONTEXT;
    ...
    /**
     * Retrieves global context for all variables of the {@link Money} type.
     *
     * @return current state of system context
     */
    ...
    /**
     * Sets or update custom {@code MoneyContext} for a {@link Money} instance.
     *
    ...
    /**
     * Retrieves the current {@code MoneyContext} in use for a {@link Money} instance.
     *
     * <p>
     * If a custom context is set, method returns it as the current context;
