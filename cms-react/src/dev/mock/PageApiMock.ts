    ...
    [
      {
        ...
        layout: 'custom',
        url: '/page1',
        html: "<div><h1>Page Html 1</h1><p>Page text 1</p></div>",
      },
      {
        id: 2,
        title: 'Page - 2',
      ...
      },
      {
        ...
        layout: 'custom',
        url: '/page3',
        html: "<div><h4>Page Html 3</h4><p>Page text 3</p><p>Other Page text 3</p><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae distinctio doloremque illum iure neque nisi perspiciatis quas quasi repudiandae sed?</p></div>",
      },
    ],
  ));
}
