...
export function mockReports() {
    ...
    this.getReport = id => {
        ...
        return {
            ...
            entity: "Enrolment",
            description: "To provide students with the information retained in onCourse regarding their enrolment and current status of their outcomes.This report prints in Portrait format.",
            preview: "",
            body: null,
            subreport: true,
            backgroundId: 1,
