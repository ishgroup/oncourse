...
export function mockVoucherProducts() {
    ...
    this.getVoucherProduct = id => {
        ...
        return {
            ...
            description: "Gift vouchers can be purchased for any amount. You will be able to nominate the voucher value during the checkout process.",
            validToOffset: null
        };
    };
...
//# sourceMappingURL=voucherProducts.js.map