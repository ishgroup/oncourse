...
export const mailchimp: IntegrationTypeSchema = {
  type: 2,
  name: "Mailchimp",
  description:
...
export const surveymonkey: IntegrationTypeSchema = {
  type: 3,
  name: "SurveyMonkey",
  description:
...
export const myob: IntegrationTypeSchema = {
  type: 6,
  name: "MYOB",
  description:
...
export const cloudassess: IntegrationTypeSchema = {
  type: 7,
  name: "Cloud Assess",
  description:
...
export const canvas: IntegrationTypeSchema = {
  type: 8,
  name: "Canvas",
  description:
...
export const micropower: IntegrationTypeSchema = {
  type: 9,
  name: "Micropower",
  description: "Micropower is a powerful users and memberships management platform."
};

export const usi: IntegrationTypeSchema = {
  type: 10,
  name: "USI Agency",
  description:
...
export const tsci: IntegrationTypeSchema = {
  type: 11,
...
export const googleclassroom: IntegrationTypeSchema = {
  type: 12,
...
export const coassemble: IntegrationTypeSchema = {
  type: 13,
  name: "Coassemble",
  description:
...
export const talentlms: IntegrationTypeSchema = {
  type: 14,
  name: "TalentLMS",
  description:
...
export const learndash: IntegrationTypeSchema = {
  type: 15,
  name: "LearnDash",
  description:
