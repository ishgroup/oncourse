...
const Table = ({
  ...
  ), [isDraggingColumn, columnSizing, columnVisibility]);
  ...
  )), [columnSizing, columnVisibility, columnOrder, rowSelection, recordsCount, mainContentWidth, threeColumn, onRowDoubleClick]);
