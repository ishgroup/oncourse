...
export const getTotalByFeeExTax = (taxRate: number, feeExTax: number): number => new Decimal(feeExTax || 0).mul(new Decimal(1).plus(taxRate || 0)).toDecimalPlaces(2, Decimal.ROUND_HALF_EVEN).toNumber();
