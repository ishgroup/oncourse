...
import { GET_PREFERENCES_BY_KEYS_REQUEST, GET_PREFERENCES_BY_KEYS_FULFILLED } from "../actions";
import { Categories } from "../../../model/preferences";

const request: EpicUtils.Request<any, any, { keys: string[]; category: Categories }> = {
