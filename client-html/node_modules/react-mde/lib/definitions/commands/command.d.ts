...
export declare type ToolbarCommands = string[][];
export declare type CommandMap = Record<string, Command>;
...
export declare type SaveImageHandler = (data: ArrayBuffer) => AsyncGenerator<string, boolean>;
