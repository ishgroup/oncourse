...
<html lang="en">
<head>
    <title>Code coverage report for src/lib.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> lib.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">6x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { stringify } from 'query-string';
import md5 from 'md5';
&nbsp;
