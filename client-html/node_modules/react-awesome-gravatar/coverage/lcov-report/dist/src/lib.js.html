...
<html lang="en">
<head>
    <title>Code coverage report for dist/src/lib.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">dist/src</a> lib.js
    </h1>
    <div class='clearfix'>
...
exports.getGravatarUrl = function (email, options) {
    ...
    return "https://www.gravatar.com/avatar/" + emailHash + "?" + query_string_1.stringify(query);
};
&nbsp;</pre></td></tr>
</table></pre>
