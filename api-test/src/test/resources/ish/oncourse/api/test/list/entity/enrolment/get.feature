...
#       <--->
    ...
    Scenario: (+) Get Enrolment id=1 by admin
        ...
        "createdOn":"#ignore",
        "modifiedOn":"#ignore",
        "assessments":[{"modifiedOn":"2019-09-11T12:48:40.000Z","code":"code1","documents":[],"name":"assessment 1","active":true,"description":"some description","id":1000,"createdOn":"2019-09-11T12:45:19.000Z","tags":[]}],
        "submissions":[]
        }
        """
