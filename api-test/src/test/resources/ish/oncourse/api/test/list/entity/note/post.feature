...
#       <---> Assertion:
        ...
        When method GET
        Then status 200
        And match $ contains [{"id":"#number","created":"#ignore","interactionDate":"#ignore","modified":"#ignore","message":"create note1","createdBy":"onCourse Administrator","modifiedBy":null,"entityName":"Course","entityId":2,"readonly":false}]
...
#       <---> Assertion:
        ...
        When method GET
        Then status 200
        And match $ contains [{"id":"#number","created":"#ignore","interactionDate":"#ignore","modified":"#ignore","message":"create note2","createdBy":"UserWithRightsDelete UserWithRightsDelete","modifiedBy":null,"entityName":"Course","entityId":2,"readonly":false}]
