...
Feature: Main feature for all GET requests with path 'dashboard/search'
    ...
    Scenario: (+) Get search result by admin
        ...
        * table getSearch
            ...
            | 'account'     | []                                                |
            | 'refund'      | [{"entity":"Contact","items":[{"id":19,"name":"student1 refund #13"}]},{"entity":"Enrolment","items":[{"id":109,"name":"student1 refund #13 course4-1"}]},{"entity":"AbstractInvoice","items":[{"id":27,"name":"student1 refund, #28"},{"id":25,"name":"student1 refund, #26"}]}]     |
