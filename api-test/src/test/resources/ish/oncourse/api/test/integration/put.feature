...
#       <--->
        ...
        * def integrationToUpdate = {id: '#(id)', name: 'updatedName', type: 3}
...
#       <--->
        ...
        * def integrationToUpdate = {name: 'updatedName', type: 3}
        Given path ishPath + '/' + id
        And request integrationToUpdate
        When method PUT
        Then status 204
...
#       <--->
        * def integration1 = {name: 'someName1', type: 3}
        * def integration2 = {name: 'someName2', type: 3}
...
#       <--->
        ...
        * def integrationToUpdate = {id: '#(id1)', name: 'updatedName', type: 3}
...
#       <--->
        ...
        * def integrationToUpdate = {name: 'someName1', type: 3}
        Given path ishPath + '/' + id2
        And request integrationToUpdate
        When method PUT
        Then status 400
...
#       <--->
        ...
        * def integrationToUpdate = {name: '', type: 3}
        Given path ishPath + '/' + id
        And request integrationToUpdate
        When method PUT
        Then status 400
...
#       <--->
        ...
        * def integrationToUpdate = {name: null, type: 3}
        Given path ishPath + '/' + id
        And request integrationToUpdate
        When method PUT
        Then status 400
...
#       <--->
        * def integration = {name: 'someName', type: 3}
        ...
        Then status 204
#       <--->
        * def integrationToUpdate = {name: 'someNameUPD', type: 3}
