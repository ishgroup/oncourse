...
#       <---> Assertion:
        ...
        "rooms":
            [
            {"id":"#number","name":"room001","seatedCapacity":100,"siteId":"#number","siteTimeZone":null,"directions":null,"facilities":null,"tags":[],"documents":[],"rules":[],"createdOn":null,"modifiedOn":null},
            ],
        "documents":[],
