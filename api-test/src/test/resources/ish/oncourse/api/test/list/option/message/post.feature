...
#       <--->
    ...
    Scenario: (-) Send email with not suitable template

#       <--->
        * def sendMessageRequest =
        """
        {"templateId":34,"entity":"WaitingList","variables":{},
            "sendToStudents":true,"sendToTutors":true,"sendToOtherContacts":true,"sendToSuppressStudents":false,"sendToSuppressTutors":false,"sendToSuppressOtherContacts":false,"fromAddress":"sales@gmail.com","searchQuery":{"search":"id in (1000,1001)","pageSize":2,"offset":2,"filter":"","tagGroups":[]}}
        """
        ...
        When method POST
        Then status 400
        And match $.errorMessage contains "is not valid for WaitingList records"


    Scenario: (-) Send email with unrecognized entity

#       <--->
        * def sendMessageRequest =
        """
        {"templateId":34,"entity":"Payslip","variables":{},
            "sendToStudents":true,"sendToTutors":true,"sendToOtherContacts":true,"sendToSuppressStudents":false,"sendToSuppressTutors":false,"sendToSuppressOtherContacts":false,"fromAddress":"sales@gmail.com","searchQuery":{"search":"id in (1000,1001)","pageSize":2,"offset":2,"filter":"","tagGroups":[]}}
        """
        ...
        When method POST
        Then status 400
        And match $.errorMessage == "Impossible to create expression. Unrecognized entity name."




#    Scenario: (+) Send email by notadmin with access rights
#
##       <--->  Login as notadmin:
