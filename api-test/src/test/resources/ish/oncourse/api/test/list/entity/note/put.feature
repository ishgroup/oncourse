...
#       <---> Assertion:
        ...
        When method GET
        Then status 200
        And match $ contains [{"id":"#(~~noteId)","created":"#ignore","modified":"#ignore","message":"update note1UPD","createdBy":"onCourse Administrator","modifiedBy":"onCourse Administrator","entityName":"Course","entityId":2,"interactionDate":"#ignore","readonly":false}]
...
#       <---> Assertion:
        ...
        When method GET
        Then status 200
        And match $ contains [{"id":"#(~~noteId)","created":"#ignore","interactionDate":"#ignore","modified":"#ignore","message":"update note2UPD","createdBy":"onCourse Administrator","modifiedBy":"UserWithRightsDelete UserWithRightsDelete","entityName":"Course","entityId":2,"readonly":false}]
