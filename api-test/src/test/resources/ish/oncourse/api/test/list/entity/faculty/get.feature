    ...
    Scenario: (+) Get faculty by admin
        ...
        And match $ contains
            """
            {
              ...
              "tags": [],
              "documents": [],
              "relatedCourses": [{"relatedSellables":[],"code":"lead1","qualificationId":null,"documents":[],"isTraineeship":null,"customFields":{},"hasEnrolments":null,"rules":[],"fieldOfEducation":null,"createdOn":null,"modifiedOn":null,"studentWaitingListCount":null,"reportableHours":null,"dataCollectionRuleId":null,"id":112,"selfPacedclassesCount":null,"webDescription":null,"shortWebDescription":null,"feeHelpClass":null,"passedClasseCount":null,"isVET":null,"cancelledClassesCount":null,"currentClassesCount":null,"qualNationalCode":null,"allowWaitingLists":null,"modules":[],"fullTimeLoad":null,"tags":[],"qualLevel":null,"facultyId":null,"enrolmentType":null,"isSufficientForQualification":null,"brochureDescription":null,"currentlyOffered":null,"name":"FirstLeadCourse","dataCollectionRuleName":null,"futureClasseCount":null,"unscheduledClasseCount":null,"qualTitle":null,"status":null}]
            }
            """
