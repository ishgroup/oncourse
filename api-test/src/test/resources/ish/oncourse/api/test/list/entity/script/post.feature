...
Feature: Main feature for all POST requests with path 'list/entity/script' without license
    ...
    Scenario: (+) Add script without panels by admin
        ...
        * def id = response.rows[0].id
        ...
        "enabled":true,
        "trigger":{"type":"On demand","entityName":null,"cron":null},"content":"def run(args) {}",
        "lastRun":[],
    ...
    Scenario: (+) Add script with Query panel by admin
        ...
        * def id = response.rows[0].id
        ...
        "description":null,
        "enabled":true,
        "trigger":{"type":"On create","entityName":"Site","cron":null},
        "lastRun":[],
...
#       <--->
        ...
        * def id = response.rows[0].id
        ...
        "description":"some description",
        "enabled":true,
        "trigger":{"type":"On demand","entityName":null,"cron":null},
        "content":"def run(args) {}",
        "lastRun":[],
