...
#       <--->
        ...
        * def newCourse =
        ...
        "tags":[{"id":227}],
        "documents":[{"id":200}],
        "relatedSellables":[{"id":1,"code":"course1","name":"Course1","active":true,"type":"Course"}],
        "modules":[],
        "dataCollectionRuleId":"101",
        "brochureDescription":"some description",
        "qualificationId":3,
...
#       <---> Verification:
        ...
        "relatedSellables":[{"id":1,"name":"Course1 course1","code":"course1","active":true,"type":"Course","expiryDate":null}],
        "qualificationId":3,
        "qualNationalCode":"10218NAT",
        "qualTitle":"Aboriginal Language/s v2",
        "qualLevel":"Certificate I in",
