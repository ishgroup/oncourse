...
#       <---> Verification:
        ...
        "modules":[{"creditPoints":null,"expiryDays":null,"fieldOfEducation":null,"id":3,"isCustom":null,"type":"UNIT OF COMPETENCY","isOffered":true,"nationalCode":"AUM1001A","nominalHours":"#number","specialization":null,"title":"Manage personal career goals","createdOn":"#ignore","modifiedOn":"#ignore", "creditPointsStatus":null}],
        "customFields":{},
