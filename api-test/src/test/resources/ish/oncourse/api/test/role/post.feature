...
Feature: Main feature for all POST requests with path 'role'
    ...
    Scenario: (+) Create new user Role
        ...
        * def someRole = { "name":"Test Role","rights":{"Certificate":"Create","Waiting list":"Print","Enrolment":"Create","Site":"Create","Room":"Create","Course":"Create","Class":"Create","Enrolment outcomes":"Edit","Budget":"View","Session":"Delete","Discount":"Create","Contact":"Delete","Users":"Delete","Purchase":"Delete","Invoice":"Create","Payment in":"Delete","Payment out":"Delete","Banking":"true","Reconciliation":"true","Account":"View","Transaction":"View","Report":"Create","Documents":"Create","Tag":"Create","Web page":"Create","Financial preferences":"View","General preferences":"Edit","Class duplication/rollover":"true","Class cancellation":"true","Exporting to XML and CSV":"true","Creating certificate from class":"true","SMS up to 50 contacts":"true","Email up to 50 contacts":"true","SMS over 50 contacts":"true","Email over 50 contacts":"true","Contact merging":"true","Enrolment cancellation":"true"} }
