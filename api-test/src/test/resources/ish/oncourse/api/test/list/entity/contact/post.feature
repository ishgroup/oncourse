...
Feature: Main feature for all POST requests with path 'list/entity/contact'
  ...
  Scenario: (+) Create Contact (student) by admin
    ...
    * def newContact =
        ...
        "invoiceTerms":10,
        "taxId":1,
        "customFields":{"ABN":"12345678901","cf1":"qwerty","cf2":"asdfgh"},
        "documents":[{"id":201}],
        "tags":[234],
        "memberships":[],
        "profilePicture":null,
  ...
  Scenario: (+) Create Contact (student and tutor) by admin
    ...
    * print "id = " + id
    ...
    And match $ contains
        ...
        "invoiceTerms":10,
        "taxId":1,
        "customFields":{"ABN":"12345678901","cf2":"asdfgh","cf1":"qwerty"},
        "documents":[],
        "tags":[],
        "memberships":[],
        "profilePicture":null,
...
#       <--->  Scenario have been finished. Now remove created object from DB:
  ...
  Scenario: (-) Create new Contact with empty mandatory custom field
    ...
    * def newContact =
        ...
        "invoiceTerms":10,
        "taxId":1,
        "customFields":{"ABN":"12345678901","cf1":"","cf2":"qwerty"},
        "documents":null,
        "tags":[],
        "memberships":[],
        "profilePicture":null,
  ...
  Scenario: (-) Create Contact with 'abn' >50 symbols
    ...
    * def newContact =
        ...
        "invoiceTerms":10,
        "taxId":1,
        "customFields":{"ABN":"123456789012345678901234567890123456789012345678901","cf1":"qwerty","cf2":"asdfgh"},
        "documents":null,
        "tags":[],
        "memberships":[],
        "profilePicture":null,
  ...
  Scenario: (-) Create Contact with not numeric 'abn' symbols
    ...
    * def newContact =
        ...
        "invoiceTerms":10,
        "taxId":1,
        "customFields":{"ABN":"123Abc","cf1":"qwerty","cf2":"asdfgh"},
        "documents":null,
        "tags":[],
        "memberships":[],
        "profilePicture":null,
