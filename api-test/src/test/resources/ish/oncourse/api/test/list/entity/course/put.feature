...
#       <--->
        ...
        * def courseToUpdate =
        ...
        "modules":[{"creditPoints":null,"expiryDays":null,"fieldOfEducation":null,"id":4,"isCustom":null,"type":"UNIT OF COMPETENCY","isOffered":true,"nationalCode":"AUM1002A","nominalHours":32.0,"specialization":null,"title":"Select and use tools and equipment in an automotive manufacturing environment","createdOn":"#ignore","modifiedOn":"#ignore","creditPointsStatus":"Active"}],
        "customFields":{},
