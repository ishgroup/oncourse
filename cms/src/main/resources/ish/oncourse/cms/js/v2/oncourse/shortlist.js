...
$j(document).ready(function() {
    ...
    $j(".course-cart-wrapper").on("click", "#shortlist .deleteItem a", function() {
        var fThis = $j(this);
        ...
        $j.ajax({
            ...
            success: function(msg) {
                ...
                if ($j('.product-item[data-classid=' + id + '] .enrolAction').length) {
                    $j('.product-item[data-classid=' + id + '] .enrolAction').removeClass('enrol-added-class').text("Buy Now");
                } else {
