goog.provide('iphoneStyleChckbx');


goog.require('browserDetect');

/*!
// Name:    iPhone-style Checkboxes jQuery plugin
// Version: v1
// URL:     http://ios-checkboxes.awardwinningfjords.com/ and https://github.com/tdreyno/iphone-style-checkboxes
// License: Copyright Thomas Reynolds, licensed GPL & MIT
-------------------------------------------------------------------------------------------
*/
