...
import ish.oncourse.services.college.CollegeService;
...
import ish.oncourse.services.host.WebHostNameService;
...
public class ServiceModule {
	...
	public static void bind(ServiceBinder binder) {
		...
		binder.bind(IWebHostNameService.class, WebHostNameService.class);
