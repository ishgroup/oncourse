...
public class ObjectFactory {
    ...
    private final static QName _GetLookupRequest_QNAME = new QName("http://training.gov.au/services/", "request");
    ...
    private final static QName _AddressStatesCode_QNAME = new QName("http://training.gov.au/services/", "Code");
    ...
    private final static QName _AbstractDtoEndDate_QNAME = new QName("http://training.gov.au/services/", "EndDate");
    private final static QName _AbstractDtoStartDate_QNAME = new QName("http://training.gov.au/services/", "StartDate");
    private final static QName _MappingMapsToCode_QNAME = new QName("http://training.gov.au/services/", "MapsToCode");
    private final static QName _MappingTitle_QNAME = new QName("http://training.gov.au/services/", "Title");
