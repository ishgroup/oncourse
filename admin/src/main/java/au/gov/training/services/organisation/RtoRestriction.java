...
/**
 * <p>Java class for RtoRestriction complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RtoRestriction">
 *   &lt;complexContent>
...
@XmlType(name = "RtoRestriction", propOrder = {
    "code",
    "restriction"
})
@XmlSeeAlso({
    RtoRestriction2 .class
})
public class RtoRestriction
    extends AbstractDto
{

    @XmlElementRef(name = "Code", namespace = "http://training.gov.au/services/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> code;
    @XmlElement(name = "Restriction", required = true, nillable = true)
