 ...
 *       &lt;sequence>
 *         &lt;element name="request" type="{http://training.gov.au/services/}TrainingComponentModifiedSearchRequest" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SearchByModifiedDate {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link TrainingComponentModifiedSearchRequest }{@code >}
     *     
     */
    public JAXBElement<TrainingComponentModifiedSearchRequest> getRequest() {
        return request;
    }
