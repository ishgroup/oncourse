...
public class BillingDataServiceImplTest {
	...
	{
		String original = "DI\tCHERSON01\tOCW-21\tonCourse standard hosting plan for Cherson: March, 2013 (contract until March, 2013)\t1\t1234567.890\tonCourse March, 2012\n";
		...
		calendar.set(Calendar.MONTH, 2);
		String result = MWExportFormat.HostingFormat.format(licenseData, college, calendar.getTime(), calendar.getTime(), description);
	...
	{
		String original = "DI\tCHERSON01\tOCW-21\tonCourse standard support plan for Cherson: March, 2013 (contract until March, 2013)\t1\t1234567.890\tonCourse March, 2012\n";
		Map<Long, Map<String, Object>> licenseData = new HashMap<Long, Map<String, Object>>();
		...
		calendar.set(Calendar.YEAR, 2013);
		calendar.set(Calendar.MONTH, 2);
		String result = MWExportFormat.SupportFormat.format(licenseData, college, calendar.getTime(), calendar.getTime(), description);
		assertEquals("Check result message", result,original);
	}
