...
@WebServiceClient(name = "ReferenceService", 
                  wsdlLocation = "file:/Users/marek/Development/ish-svn/willow/webservices/webservices-client/src/main/wsdl/v4_reference.wsdl",
...
public class ReferenceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/marek/Development/ish-svn/willow/webservices/webservices-client/src/main/wsdl/v4_reference.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/Users/marek/Development/ish-svn/willow/webservices/webservices-client/src/main/wsdl/v4_reference.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
