 ...
 * generated in the ish.oncourse.webservices.soap.v4.auth package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ish.oncourse.webservices.soap.v4.auth
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://auth.v4.soap.webservices.oncourse.ish/", name = "authenticate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://auth.v4.soap.webservices.oncourse.ish/", name = "authenticateResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://auth.v4.soap.webservices.oncourse.ish/", name = "logoutResponse")
