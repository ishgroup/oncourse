...
@WebServiceClient(name = "AuthenticationService", 
                  wsdlLocation = "file:/Users/marek/Development/ish-svn/willow/webservices/webservices-web/src/main/wsdl/v4_auth.wsdl",
...
public class AuthenticationService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/marek/Development/ish-svn/willow/webservices/webservices-web/src/main/wsdl/v4_auth.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/Users/marek/Development/ish-svn/willow/webservices/webservices-web/src/main/wsdl/v4_auth.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
